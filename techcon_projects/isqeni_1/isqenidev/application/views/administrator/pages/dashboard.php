...
<div id="content" class="span10">
  ...
  <div class="container-2">
        ...
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content dark-blue">
              <div class="circle-tile-description text-faded">Total Vendor</div>
        ...
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content green">
              <div class="circle-tile-description text-faded">Total Individual User</div>
        ...
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content blue">
              <div class="circle-tile-description text-faded">Total Corporate</div>
        ...
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content red">
              <div class="circle-tile-description text-faded">Total Mosque</div>
    ...
    <div class="box-content clearfix" style="direction:ltr">
      <div class="my-graph"> 
