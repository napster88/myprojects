...
<ul class="submenu" <?php if($this->uri->segment(2) == "home" || $this->uri->segment(2) == "about" || $this->uri->segment(2) == "conditions") { echo "style='display:block'"; }  ?>>      <li><a class="ajax-link" href="<?php echo site_url("administrator/home")?>"><i class="icon-home"></i><span class="hidden-tablet"> <?php echo lang("Messages")?> <span style="color: yellow; font-size: 13px; font-weight: bold;">( <?php echo $this->data->countTable("contact",array("read"=>"0"));?> )</span></span></a></li>
      ...
      <li class="nav-header hidden-tablet <?php if($this->uri->segment(2) == "settings" || $this->uri->segment(3) == "noti") { echo "open"; }  ?>">
      <div class="link"><i class="fa fa-cogs"></i><?=lang("Setting")?><i class="fa fa-chevron-down"></i></div>       
      <ul class="submenu" <?php if($this->uri->segment(2) == "settings" || $this->uri->segment(3) == "noti") { echo "style='display:block'"; }  ?>>  
...
<div class="link"><i class="fa fa-paint-brush"></i><?=lang("Products")?><i class="fa fa-chevron-down"></i></div>   
     <ul class="submenu" <?php if($this->uri->segment(2) == "products" || ($this->uri->segment(3) == "add" && $this->uri->segment(2) == "products")) { echo "style='display:block'"; }  ?>><li><a class="ajax-link" href="<?php echo site_url("administrator/products/")?>"><i class="icon-globe"></i><span class="hidden-tablet"> <?php echo lang("Show")?></span></a></li>
      <li><a class="ajax-link" href="<?php echo site_url("administrator/products/add")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> <?php echo lang("Add")?></span></a></li></ul>
      </li>
      <?php } ?>
  ...
  <ul class="submenu" <?php if($this->uri->segment(2) == "clients" || ($this->uri->segment(3) == "add" && $this->uri->segment(2) == "clients")) { echo "style='display:block'"; }  ?>>     <li><a class="ajax-link" href="<?php echo site_url("administrator/clients/")?>"><i class="icon-user"></i><span class="hidden-tablet"> <?php echo lang("Show")?></span></a></li>
          <li><a class="ajax-link" href="<?php echo site_url("administrator/clients/add")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> <?php echo lang("Add")?></span></a></li></ul>
      </li>
      <?php } ?>
