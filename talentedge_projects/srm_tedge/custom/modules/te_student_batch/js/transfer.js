app.controller("transferbatch", function($rootScope,$scope, $http) {
	...
	$scope.getResults=function(){
		...
		$http.post('index.php?module=te_student_batch&action=listtransferrequests_ajax&to_pdf=1').success(function(data, status) {
			if($scope.page>1){
