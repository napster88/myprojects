...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='email_advanced'>{sugar_translate label='LBL_EMAIL' module='Leads'}</label>
    	</td>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='phone_mobile_advanced'>{sugar_translate label='LBL_MOBILE_PHONE' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.phone_mobile_advanced.name}' id='{$fields.phone_mobile_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex=''	  class="phone" >
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='batch_c_advanced'>{sugar_translate label='LBL_BATCH' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.batch_c_advanced.name}"  class="sqsEnabled"   id="{$fields.batch_c_advanced.name}" size="" value="{$fields.batch_c_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.te_ba_batch_id_c_advanced.name}" value="{$fields.te_ba_batch_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.batch_c_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.batch_c_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"te_ba_batch_id_c_advanced","name":"batch_c_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.batch_c_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.batch_c_advanced.name}.value = ''; this.form.{$fields.te_ba_batch_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_entered_advanced) && !empty($smarty.request.date_entered_advanced)}{$smarty.request.date_entered_advanced}{else}{$smarty.request.range_date_entered_advanced}{/if}' title=''   size="11">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:0px" border="0" id="{$id}_trigger"{/capture}
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='status_description_advanced'>{sugar_translate label='LBL_STATUS_DESCRIPTION' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
