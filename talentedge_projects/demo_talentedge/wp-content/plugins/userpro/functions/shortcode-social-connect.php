<?php
	...
	function userpro_social_connect_add( $args=array() ) {
		...
		$defaults = array(
			...
			'google' => 1,
			'google_title' => __('Autofill with Google','userpro'),
			'vk' => 1,
		...
		echo '<div class="userpro-social-big">';
			...
			if ( $google == 1 && userpro_get_option('google_connect') == 1 && userpro_get_option('google_client_id') && userpro_get_option('google_client_secret') && userpro_get_option('google_redirect_uri') ) {
				...
				<a href="<?php echo $url; ?>" class="userpro-social-google" data-redirect="<?php echo $facebook_redirect; ?>" title="<?php echo $google_title; ?>"><?php echo $google_title; ?><i class="userpro-icon-google-plus fa"></i></a>
...
if ( userpro_get_option('linkedin_connect') == 1 && userpro_get_option('linkedin_app_key') && userpro_get_option('linkedin_Secret_Key') ) {
				...
				?>
			      <a class="userpro-social-linkedin wplLiLoginBtn" title="<?php echo Linkedin; ?>"><?php echo "Autofill with Linkedin"; ?><i class="icon-linked-in fa"></i></a>
						<?php
	}
