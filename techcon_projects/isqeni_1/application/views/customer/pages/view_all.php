...
<div id="content" class="span10">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
						...
						<table class="table table-striped table-bordered bootstrap-datatable">
						  <thead>
							  <tr>
								 ...
								 <th>Sr. No<?php // echo lang("Photo") ;?></th>
								  ...
								  <th>Name In English<?php // echo lang("Name") ;?></th>
								    <th>Name In Arabic<?php // echo lang("Name") ;?></th>
								  <th>Car Type English<?php // echo lang("Car Type") ;?></th>
								    <th>Car Type Arabic<?php // echo lang("Car Type") ;?></th>
									
								  <th>Color english<?php // echo lang("name_ar") ;?></th>
								    <th>Color Arabic<?php // echo lang("name_ar") ;?></th>
									 <th>Car Number<?php // echo lang("name_en") ;?></th>
								  <th>License Number<?php // echo lang("name_en") ;?></th>
								  <th>Status<?php // echo lang("price") ;?></th>
                          ...
                          foreach($driver_list AS $data_item){
                           ...
                           ?>
								...
								<a style="background:url(<?php echo $data_item['image'] ;?>)" title="<?php echo $data_item['name_en'] ;?>" href="<?php echo $data_item['image'] ;?>"><img class="grayscale" src="<?php echo base_url().'download/driver/'.$data_item['image'] ;?>" width="50px" alt="<?php echo $data_item['name_en'] ;?>"></a>
							    </li>
                                </td>
                                ...
                                <td class="center">
									...
									<a class="btn btn-danger del_rec" href="<?php echo base_url('driver/delete_driver/'.$data_item['id']);?>">
										<i class="icon-trash icon-white"></i>
				 ...
				 <script>
				jQuery('.del_rec').click(function(e){
