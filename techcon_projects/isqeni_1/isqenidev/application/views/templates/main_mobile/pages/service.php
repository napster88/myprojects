...
<h1> <?php echo lang("Services")?>  - <?php echo $data['title'];?></h1>
</div>
...
<div class="fb-share-button" data-href="<?php echo site_url("services/article-".$data['id']);?>" data-layout="button"></div>
&nbsp;
</div>
<div class="fb-comments" data-href="<?php echo site_url("services/article-".$data['id']);?>" data-numposts="10" data-width="620"></div>
