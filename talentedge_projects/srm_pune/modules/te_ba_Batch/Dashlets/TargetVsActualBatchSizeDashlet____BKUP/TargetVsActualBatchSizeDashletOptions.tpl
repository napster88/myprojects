...
<tr>
    ...
    <td valign='top'>
		<select name='target_vs_actual_enrollments_for_live_batches'>
			{if $target_vs_actual_enrollments_for_live_batches==10}
				<option value="10" selected>Top 10</option>
			{else}
				<option value="10">Top 10</option>
			{/if}
			{if $target_vs_actual_enrollments_for_live_batches==20}
				<option value="20" selected>Top 20</option>
			{else}
				<option value="20">Top 20</option>
			{/if}
			{if $target_vs_actual_enrollments_for_live_batches==30}
				<option value="30" selected>Top 30</option>
			{else}
				<option value="30">Top 30</option>
			{/if}
			{if $target_vs_actual_enrollments_for_live_batches==50}
