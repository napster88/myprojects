...
<?php } ?>
    ...
    <?php } ?>
                                        ...
                                        <td><?php if ($data->account_status == 'active') {
      echo "<span style='padding: 2px 12px;background: #00a65a;color: #fff;border-radius: 10px;line-height: 40px;'>Active</span>";
    } else {
      echo "<span style='padding: 2px 12px;background: #dd4b39;color: #fff;border-radius: 10px;line-height: 40px;'>Inactive</span>";
    } ?></td>
                                        <td>

                                            <a class="btn btn-app" href="<?php echo base_url('account/account_disable/' . $data->account_id . '/' . $acc_type); ?>"> <i class="fa fa-eye"></i><?php if ($data->account_status == 'active') {
                                  echo "Disable";
                                } else {
                                  echo "Enable";
                                } ?></a>
