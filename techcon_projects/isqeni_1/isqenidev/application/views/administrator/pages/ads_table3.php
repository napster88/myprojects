                           ...
                           ?>
							<tr>
                                ...
                                <?php if($data_item['id'] > 0){ ?>
									<a class="btn btn-info" href="<?php echo site_url("administrator/ad3/add/".$data_item['id']."");?>">
										<i class="icon-edit icon-white"></i>
										<?php echo lang("Edit") ;?>
									</a>
									<a onClick="return confirm('<?php echo lang("WantDelete") ;?>')" class="btn btn-danger" href="<?php echo site_url("administrator/ad3/delete/".$data_item['id']."");?>">
										<i class="icon-trash icon-white"></i>
