...
class status_listview {
    ...
    global $db;
       ...
       $row4 =$db->query("SELECT tbl1.id, COUNT(tbl3.batch_status) AS Total_c FROM te_in_institutes tbl1 INNER JOIN te_in_institutes_te_ba_batch_1_c tbl2 ON tbl1.id = tbl2.te_in_institutes_te_ba_batch_1te_in_institutes_ida 
               ...
               $bean->enrollment_in_progress_c= $res4['Total_c'];
