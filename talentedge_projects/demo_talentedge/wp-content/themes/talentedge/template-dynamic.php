 ...
 */
 ...
 <?php global $post;
 $post_id=$post->ID;
 $btn_color=get_field('button_color',$post_id);
$btn_text_color=get_field('button_text_color',$post_id);
 ?>
<head>
...

{
	...
	/*---kuldeep*/
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields, .gravity_form_footer > .gform_wrapper form#gform_9 .gform_body ul.gform_fields
		{
			width:100%;
			margin: 0;
			padding: 0;
		}
		.gform_wrapper form#gform_30 .gform_body ul.gform_fields, .gform_wrapper form#gform_9 .gform_body ul.gform_fields{
			width:100%;
			margin: 0;
			padding: 0 5px 10px 0;
		}
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields li, .gravity_form_footer > .gform_wrapper form#gform_9 .gform_body ul.gform_fields li{
			width: 25%;
			float: left;
			display: inline-block;
			padding-left: 15px;
		...
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields li .ginput_container input, .gravity_form_footer > .gform_wrapper form#gform_9 .gform_body ul.gform_fields li .ginput_container input{
		width: 100%;
		background-color: #fff;
		}
		.tt_cont_form .gform_wrapper form#gform_30 .gform_body ul.gform_fields li,
		...
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields li label{
			display: block;
		}
...
//  $post_id=$post->ID;
  ?>
  <style>
    <?php echo get_field('write_css_here',$post_id); ?>
  </style>
<?php
  $course=get_field('select_course',$post_id);
  ...
  $course_id=$course[0]->ID;
    ...
    <nav class="navbar navbar-fixed-top transparent navbar-default">
		...
		$inst_logo=get_field('institute_logo',$post_id);?>

			<!-- Navbar Logo -->
			<a class="ui-variable-logo navbar-brand iimk" href="<?php echo site_url()."/iim-kashipur"; ?>" title="Talentedge">
            <img class="logo-default" src="<?php echo  get_template_directory_uri();?>/images/logo/kashipur.jpg" alt="Talentedge" data-uhd>
				<!-- Transparent Logo -->
				<img class="logo-transparent martop20" src="<?php echo $inst_logo['url'];?>" alt="Talentedge" data-uhd>
				<!-- Default Logo -->
    ...
    <div class="main" role="main">
    	...
    	<!-- Hero Slider -->
		<div class="ui-hero ui-hero-slider slider-pro hero-lg" 	data-fade="true" 	data-touch_swipe="false" 			data-auto_play="true" 			data-autoplay_delay="5500" 			data-autoplay_on_hover="none" 			data-show_dots="true" 			data-show_arrows="true" >
			<div class="sp-slides fade">

    <?php

$bannerhead=get_field('Tag_line',$post_id);

    foreach($bannerhead as $key=>$val){
  ?>
                <div class="sp-slide">
					<div class="container">
						<div class="row">
							<div class="col-sm-12" data-vertical_center="true" data-vertical_offset="16">
								<h1 class="heading sp-layer" data-show-transition="left" data-show-delay="300" data-show-duration="500">
									<?php echo $val['banner_tagline_heading']; ?>
								</h1>
							<p class="paragraph sp-layer" data-show-transition="left" data-show-delay="400" data-show-duration="500">
								<!--	<img src="<?php // echo site_url();?>/wp-content/uploads/2018/03/title1.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive desk" >
                                  ...
                                  -->
                                  				<?php echo $val['banner_tagline_text']; ?>
								</p>
...
<?php  } ?>
   ...
   <div class="section ui-gradient-peach form ui-action-section" id="form11">
   			<div class="container-fluid">
   				<div class="">
                    ...
                    <h3><?php echo get_field('footer_enroll_form_title',$post_id); ?>   </h3>
                  <h3><?php echo get_field('footer_enroll_form_title_two',$post_id); ?>   </h3>
            ...
            echo do_shortcode('[gravityform id = 30	title=false description=false ajax=false tabindex=30]');
            ?>
  ...
  <ul class="actions">
    <li>
<?php $enroll_now_btn=get_field('sticky_enroll_button',$post_id); ?>
      <a href="#" id="contact" class="button big">
        <div style="padding:5px 10px; border:1px solid #e7e7e7; border-radius:5px; background-color:<?php echo $btn_color;?>; color:<?php echo $btn_text_color;?>; "><?php echo get_field('sticky_enroll_button',$post_id); ?></div>



      <!--  <img src="<?php // echo $enroll_now_btn['url']; ?>" alt="btn"> -->
    </a>

      </li>
<!--
      <a href="#" id="contact" class="button big"><img src="<?php // echo site_url();?>/wp-content/uploads/2018/03/enrol-btn.png" alt="btn"></a></li>
-->
  </ul>
</div>
...
<?php  if(get_field('enable_first_section',$post_id)=='1') { ?>
   		<!-- Call To Action Section -->
   		<div class="section " >
   			<div class="container">
   				<div class="row">
            <div class="col-lg-12">
              <?php $color=array('1'=>array('orange','white','red'),
                                  '2'=>array('blue','red','white',),
                                  '3'=>array('red','white','orange'),
                                  '4'=>array('white','orange','blue')
            );

              $column_text=get_field('column_text',$post_id);
              $i=1;
              foreach($column_text as $key=>$val)
              { ?>
                <div class="cat-sec">
                  <div class="row no-gape">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                               <div class="p-category <?php echo $val['column_1_color']; ?> <?php // echo $color[$i][0]; ?>">
                        <div>
                          <i class="la la-bullhorn"></i>
                          <span><?php echo $val['column_1_text']; ?></span>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="p-category <?php echo $val['column_2_color']; ?><?php // echo $color[$i][1]; ?>">
                        <div>
                          <i class="la la-graduation-cap"></i>
                          <span><?php echo $val['column_2_text']; ?></span>

                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="p-category <?php echo $val['column_3_color']; ?><?php // echo $color[$i][2]; ?>">
                        <div>
                          <i class="la la-line-chart "></i>
                          <span><?php echo $val['column_3_text']; ?></span>
...
<?php  if(get_field('enable_two_section',$post_id)=='1') { ?>
      <div class="section second ui-showcase-section">
   			<div class="container">

   				<div class="section-heading center">
   					<h2 class="heading text-indigo">
                <?php  echo get_field('section_two_heading',$post_id);   ?>
   					</h2>
   					<p class="paragraph">
              <?php

            $mm=get_post_meta('41424');

            //echo "<pre>";
            //print_r($mm);
              echo get_field('section_two_description',$post_id);

               ?>
   					</p>
   				</div>
   				<div class="row">
              <?php $url=get_field('section_two_image',$post_id); ?>
   					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-7 animate certi" data-show="fade-in-right">
	             <img src="<?php echo $url['url'];   ?>" alt="Talentedge" data-uhd data-max_width="489"/>
            <!-- <img src="<?php // echo site_url();?>/wp-content/uploads/2018/03/iim-ba1.png" alt="Talentedge" data-uhd data-max_width="489"/> -->
              ...
              <?php $features=get_field('section_two_features',$post_id);
            //  echo "<pre>";
              ...
              foreach($features as $key=>$val)
                ...
                ?>
   							...
   							<li class="ui-icon-block animate points" data-show="fade-in">
   								<span class="<?php echo $val['icon']; ?> text-purple"></span>
   								<h5 class="text-dark-gray"><?php echo $val['text']; ?></h5>
   							</li>
          ...
          <?php  if(get_field('enable_download_brochure',$post_id)=='1') { ?>

                <div class="section-heading center mb-0 martop40">

   					<a href="#">
   					<h2 class="heading brochure">
   						<?php echo get_field('section_two_broucher_download', $post_id); ?>
   					</h2>
              </a>
   					<p class="paragraph">
              <?php echo get_field('download_brochure_tagline', $post_id); ?>
...
<?php  if(get_field('enable_third_section',$post_id)=='1') { ?>
        <div class="section fouth bg-elig">
   			<div class="container">

   				<div class="section-heading center">
   					<h2 class="heading text-indigo">
   					<?php echo get_field('section_three_heading',$post_id); ?>
   					</h2>
                ...
                <div class="row">
                    ...
                    <?php $add_rows=get_field('add_rows',$post_id);
                    foreach($add_rows as $key=>$val)
                      {
                      ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                      <div class="boxpack1">
                          ...
                          <h2><?php echo $val['section_three_row_heading'];?></h2>
                          <p class="paragraph">
         						          <span><?php echo $val['section_three_row_subheading'];?></span>
         					                 <br><br>

         						          <?php echo $val['section_three_row_description'];?>
     					             </p>
                      </div>
...
<?php }?>
      ...
      <?php  if(get_field('enable_forth_section',$post_id)=='1') { ?>
   		<div class="section">
   			<div class="container">
   				<!-- Card Heading -->
   				<div class="section-heading center">
   					<h2 class="heading text-indigo">
   							<?php echo get_field('section_four_heading',$post_id); ?>

   					</h2>

   				</div><!-- .section-heading -->
<?php $sec_image= get_field('section_four_image',$post_id); ?>
   				<div class="col-sm-4 col-xs-12 ui-icon-block text-center media3">
   						<div class="icon icon-lg text-lime"><img src="<?php echo $sec_image['url'];?>" alt="alumuni" class="img-circle"></div>
   						<h4><?php echo get_field('section_four_title',$post_id); ?></h4>
                        <h5><?php echo get_field('section_four_designation',$post_id); ?>
                        <?php echo get_field('section_four_company',$post_id); ?>
                          <br><?php echo get_field('section_four_batch',$post_id); ?></h5>
   					</div>
                    <div class="col-sm-8 col-xs-12 ui-icon-block text-center media3">
   						<p>
							<?php echo get_field('section_four_description',$post_id); ?>		</p>
   					</div>
   			</div><!-- .container -->
   		</div><!-- .section -->
<?php } ?>
