...
<tr>
    ...
    <td valign='top'>
		<select name='TargetVsActualBatchSizeDashlet'>
			{if $TargetVsActualBatchSizeDashlet==10}
				<option value="10" selected>Top 10</option>
			{else}
				<option value="10">Top 10</option>
			{/if}
			{if $TargetVsActualBatchSizeDashlet==20}
				<option value="20" selected>Top 20</option>
			{else}
				<option value="20">Top 20</option>
			{/if}
			{if $TargetVsActualBatchSizeDashlet==30}
				<option value="30" selected>Top 30</option>
			{else}
				<option value="30">Top 30</option>
			{/if}
			{if $TargetVsActualBatchSizeDashlet==50}
