			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						&nbsp;
						<div class="box-icon">
							<a class="btn btn-danger btn-small" href="javascript:document.getElementById('table_form').submit();" onClick="return confirm('<?php echo lang("WantDelete") ;?> ')">
						...
						<table class="table table-striped table-bordered bootstrap-datatable">
						  <thead>
                              ...
                              <tr style="display: none;">
								  ...
								  <td>&nbsp;</td>
								  <td>
                                  <a class="btn btn-primary" href="javascript:showActivities('0');">
                          ...
                          foreach($data AS $data_item){
                           ...
                           ?>
                                ...
                                <!--<td class="center" id="counts<?php echo $data_item['id'] ;?>"><?php echo  $count + 1 ;?></td>-->
                                <td class="center">
								   	<a class="btn btn-info" href="<?php echo site_url("administrator/products/add/".$data_item['id']);?>">
                                    ...
                                    <a class="btn btn-primary" href="javascript:showActivities('<?php echo $data_item['id']?>');">
										<i class="fa fa-picture-o"></i>
                                        <?php echo lang("Addimages") ;?>
									</a>
                                    ...
                                    <a class="btn btn-success" href="javascript:showActivities2('<?php echo $data_item['id']?>');">
										<i class="fa fa-picture-o"></i>
                                        <?php echo lang("Showimages") ;?>
									</a>
