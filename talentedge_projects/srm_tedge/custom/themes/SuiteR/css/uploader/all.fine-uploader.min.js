...
var qq = function(a) {
    ...
    return {
        ...
        getByClass: function(b, c) {
            var d, e = [];
            return c && a.querySelector ? a.querySelector("." + b) : a.querySelectorAll ? a.querySelectorAll("." + b) : (d = a.getElementsByTagName("*"), qq.each(d, function(a, c) {
...
function() {
...
}(), qq.version = "5.5.0", qq.supportedFeatures = function() {
        "use strict";
    ...
    function() {
        ...
        qq.basePublicApi = {
            ...
            _createStore: function(a, b) {
                ...
                return {
                    ...
                    addReadOnly: function(a, b) {
                        qq.isObject(c) && (null === a ? qq.isFunction(b) ? f = b : (f = f || {}, qq.extend(f, b)) : (e[a] = e[a] || {}, qq.extend(e[a], b)))
                    },
                    remove: function(a) {
                        return delete c[a]
                    },
            ...
            _uploadStoredFiles: function() {
                for (var a, b, c = this; this._storedIds.length;) a = this._storedIds.shift(), this._uploadFile(a);
                b = this.getUploads({
                    status: qq.status.SUBMITTING
                }).length, b && (qq.log("Still waiting for " + b + " files to clear submit queue. Will re-parse stored IDs array shortly."), setTimeout(function() {
    ...
    function() {
        ...
        function e() {
            var a;
            return (window.XMLHttpRequest || window.ActiveXObject) && (a = qq.createXhrInstance(), void 0 === a.withCredentials && (a = new XDomainRequest, a.onload = function() {}, a.onerror = function() {}, a.ontimeout = function() {}, a.onprogress = function() {})), a
        }
        ...
        t = "GET" === w.method || "DELETE" === w.method, qq.extend(this, {
            initTransport: function(a) {
                ...
                return {
                    ...
                    send: function(h) {
                        return f && qq.indexOf(["GET", "DELETE"], w.method) >= 0 && (c.qqtimestamp = (new Date).getTime()), r(a, h, b, c, g, d, e)
                    }
                }
            },
            canceled: function(a) {
    ...
    function() {
        ...
        qq.uiPublicApi = {
            ...
            _addToList: function(a, b, c) {
                ...
                this._options.display.prependFiles && (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (f = this._filesInBatchAddedToUi - 1), d = {
                    index: f
        ...
        var b, c, d, e, f, g, h, i, j = "qq-file-id",
            ...
            B = new qq.Promise,
            C = function() {
                var a = x.placeholders.thumbnailNotAvailable,
                    c = x.placeholders.waitingForThumbnail,
                    d = {
                        maxSize: w,
                        scale: i
                    };
            ...
            P = function(a) {
                return null == a ? T(f, y.totalProgressBarContainer) || T(f, y.totalProgressBar) : T(M(a), y.progressBarContainer) || T(M(a), y.progressBar)
            },
            Q = function(a) {
            ...
            X = function(a, b) {
                var c = z[a] || (new qq.Promise).failure(),
                    d = new qq.Promise;
            ...
            Y = function() {
                ...
                if (b("Parsing template"), null == x.templateIdOrEl) throw new Error("You MUST specify either a template element or ID!");
                if (qq.isString(x.templateIdOrEl)) {
                    if (a = document.getElementById(x.templateIdOrEl), null === a) throw new Error(qq.format("Cannot find template script at ID '{}'!", x.templateIdOrEl));
                    e = a.innerHTML
                } else {
                    if (void 0 === x.templateIdOrEl.innerHTML) throw new Error("You have specified an invalid value for the template option!  It must be an ID or an Element.");
                    e = x.templateIdOrEl.innerHTML
                }
                if (e = qq.trimStr(e), g = document.createElement("div"), g.appendChild(qq.toElement(e)), t = qq(g).getFirstByClass(y.uploader), x.button && (k = qq(g).getFirstByClass(y.button), k && qq(k).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (r = qq(g).getFirstByClass(y.dropProcessing), r && qq(r).remove()), p = qq(g).getFirstByClass(y.drop), p && !qq.DragAndDrop && (b("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop ? qq(t).hasAttribute(o) && p && (s = qq(p).getFirstByClass(y.dropText), s && qq(s).remove()) : (t.removeAttribute(o), p && qq(p).hasAttribute(n) && qq(p).css({
                        display: "none"
                    })), q = qq(g).getFirstByClass(y.thumbnail), h ? q && (w = parseInt(q.getAttribute(l)), w = w > 0 ? w : null, i = qq(q).hasAttribute(m)) : q && qq(q).remove(), h = h && q, c = qq(g).getByClass(y.editFilenameInput).length > 0, d = qq(g).getByClass(y.retry).length > 0, f = qq(g).getFirstByClass(y.list), null == f) throw new Error("Could not find the file list container in the template!");
            ...
            $ = function(a) {
                ...
                qq.supportedFeatures.imagePreviews ? e ? x.limits.maxThumbs && x.limits.maxThumbs <= t ? (X(b, e), F()) : D(e).done(function() {
            ...
            _ = function(a) {
                ...
                if (e)
                    if (c) {
                        if (!(x.limits.maxThumbs && x.limits.maxThumbs <= t)) return d && D(e), x.imageGenerator.generate(c, e, f).then(function() {
            ...
            ab = function(a, b) {
                var c = P(a),
                    d = null == a ? y.totalProgressBar : y.progressBar;
            ...
            cb = function(a, c) {
                var d = U(a),
                    e = U(c);
                b(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", a, c, c)), z[c].then(function() {
                    t++, z[a].success(), b(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", c, a)), d.src = e.src, bb(d)
                }, function() {
                    z[a].failure(), x.placeholders.waitUntilUpdate || X(a, d)
                })
            };
        qq.extend(x, a), b = x.log, qq.supportedFeatures.imagePreviews || (x.limits.timeBetweenThumbs = 0, x.limits.maxThumbs = 0), f = x.containerEl, h = void 0 !== x.imageGenerator, e = Y(), C(), qq.extend(this, {
            render: function() {
                b("Rendering template in DOM."), t = 0, f.innerHTML = e.template, V(K()), this.hideTotalProgress(), g = x.fileContainerEl || T(f, y.list), b("Template rendering complete")
            },
            ...
            addFile: function(a, b, c, d, h) {
                var i, l = qq.toElement(e.fileTemplate),
                    m = T(l, y.file),
                    n = T(f, y.uploader),
                    p = h ? r.content : g;
                h && (r.map[a] = l), qq(l).addClass(k + a), n.removeAttribute(o), m && (qq(m).setText(b), m.setAttribute("title", b)), l.setAttribute(j, a), c ? Z(l, c.index, p) : p.appendChild(l), d ? (l.style.display = "none", qq(l).addClass(q)) : (V(P(a)), V(R(a)), V(J(a)), V(Q(a)), V(O(a)), V(H(a)), s && this.hideCancel(a), i = U(a), i && !i.src && B.then(function(a) {
            ...
            showDialog: function(a, b, c) {
                var d = I(a),
                    e = T(d, y.dialogMessage),
                    f = d.getElementsByTagName("INPUT")[0],
                    g = T(d, y.dialogCancelButton),
                    h = T(d, y.dialogOkButton),
                    i = new qq.Promise,
                    j = function() {
            ...
            handleNewFile: function(a, b, c, d, e, f, g, h) {
                ...
                qq.each(i.getFileRecords(c, b, a), function(a, b) {
                    ...
                    b.blob instanceof qq.BlobProxy && (d = -1), c = m.addFile({
                        ...
                        batchId: f,
                        proxyGroupId: o
                    }), b.blob instanceof qq.BlobProxy ? j.push(c) : k = c, b.blob ? (l(c, b.blob), e.push({
                        id: c,
                        file: b.blob
...
qq.TotalProgress = function(a, b) {
        ...
        return {
            ...
            _getPrefixedParamName: function(a) {
                return qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, a) >= 0 ? a : qq.s3.util.AWS_PARAM_PREFIX + a
            },
            getPolicy: function(a) {
                var b = {},
                    ...
                    l = a.sessionToken,
                    m = a.params,
                    n = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl),
                    o = a.minFileSize,
                    p = a.maxFileSize,
                    q = a.reducedRedundancy,
                    r = a.region,
                    s = a.serverSideEncryption,
                    t = a.signatureVersion;
                return b.expiration = qq.s3.util.getPolicyExpirationDate(e, f), c.push({
                    acl: i
                }), c.push({
                    bucket: d
                }), j && c.push({
                    ...
                    success_action_status: k.toString()
                }), n && c.push({
                    success_action_redirect: n
                }), q && (c.push({}), c[c.length - 1][qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), l && (c.push({}), c[c.length - 1][qq.s3.util.SESSION_TOKEN_PARAM_NAME] = l), s && (c.push({}), c[c.length - 1][qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), 2 === t ? c.push({
                    key: g
                }) : 4 === t && (c.push({}), c[c.length - 1][qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, c.push({}), c[c.length - 1].key = g, c.push({}), c[c.length - 1][qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({
                    date: e,
                    key: h,
                    region: r
                }), c.push({}), c[c.length - 1][qq.s3.util.DATE_PARAM_NAME] = qq.s3.util.getV4PolicyDate(e, f)), qq.each(m, function(a, b) {
                    var d = qq.s3.util._getPrefixedParamName(a),
                        e = {};
                    e[d] = qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, d) >= 0 ? b : encodeURIComponent(b), c.push(e)
                }), b.conditions = c, qq.s3.util.enforceSizeLimits(b, o, p), b
            },
            ...
            generateAwsParams: function(a, b) {
                var c, d = {},
                    ...
                    p = a.region,
                    q = a.serverSideEncryption,
                    r = a.signatureVersion,
                    s = new Date,
                    t = a.log;
                return a.date = s, c = qq.s3.util.getPolicy(a), d.key = j, i && (d["Content-Type"] = i), m && (d.success_action_status = m), n && (d.success_action_redirect = n), o && (d[qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), q && (d[qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), g && (d[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = g), d.acl = l, qq.each(e, function(a, b) {
                    var c = qq.s3.util._getPrefixedParamName(a);
                    d[c] = qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, c) >= 0 ? b : encodeURIComponent(b)
                }), 2 === r ? d.AWSAccessKeyId = k : 4 === r && (d[qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, d[qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({
                    date: s,
                    key: k,
                    region: p
                }), d[qq.s3.util.DATE_PARAM_NAME] = qq.s3.util.getV4PolicyDate(s, h)), b(c).then(function(b, c, e) {
                    d.policy = b.policy, 2 === a.signatureVersion ? (d.signature = b.signature, c && (d.AWSAccessKeyId = c)) : 4 === a.signatureVersion && (d[qq.s3.util.V4_SIGNATURE_PARAM_NAME] = b.signature), e && (d[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = e), f.success(d)
                }, function(a) {
                    a = a || "Can't continue further with request to S3 as we did not receive a valid signature and policy from the server.", t("Policy signing failed.  " + a, "error"), f.failure(a)
                }), f
            },
            ...
            getPolicyExpirationDate: function(a, b) {
                var c = new Date(a.getTime() + b);
                return qq.s3.util.getPolicyDate(c, 5)
            },
            getCredentialsDate: function(a) {
                return a.getUTCFullYear() + "" + ("0" + (a.getUTCMonth() + 1)).slice(-2) + ("0" + a.getUTCDate()).slice(-2)
            },
            getPolicyDate: function(a, b) {
                var c, d, e = b || 0;
                return a.setMinutes(a.getMinutes() + (e || 0)), Date.prototype.toISOString ? a.toISOString() : (c = function(a) {
                    return d = String(a), 1 === d.length && (d = "0" + d), d
                }, a.getUTCFullYear() + "-" + c(a.getUTCMonth() + 1) + "-" + c(a.getUTCDate()) + "T" + c(a.getUTCHours()) + ":" + c(a.getUTCMinutes()) + ":" + c(a.getUTCSeconds()) + "." + String((a.getUTCMilliseconds() / 1e3).toFixed(3)).slice(2, 5) + "Z")
            },
            ...
            getV4CredentialsString: function(a) {
                return a.key + "/" + qq.s3.util.getCredentialsDate(a.date) + "/" + a.region + "/s3/aws4_request"
            },
            getV4PolicyDate: function(a, b) {
                var c = new Date(a.getTime() + b);
                return qq.s3.util.getCredentialsDate(c) + "T" + ("0" + c.getUTCHours()).slice(-2) + ("0" + c.getUTCMinutes()).slice(-2) + ("0" + c.getUTCSeconds()).slice(-2) + "Z"
            },
    ...
    function() {
        ...
        qq.nonTraditionalBasePublicApi = {
            ...
            setUploadSuccessEndpoint: function(a, b) {
    ...
    function() {
        ...
        qq.s3.FineUploaderBasic = function(a) {
            var b = {
                ...
                objectProperties: {
                    ...
                    host: qq.bind(function(a) {
                        return /(?:http|https):\/\/(.+)(?:\/.+)?/.exec(this._endpointStore.get(a))[1]
                    }, this),
                    key: "uuid",
                    reducedRedundancy: !1,
                    region: "us-east-1",
                    ...
                    return {
                        get: function(b) {
                            ...
                            return qq.each(c, function(a, b) {
                                var c = a;
                                qq.indexOf(qq.s3.util.CASE_SENSITIVE_PARAM_NAMES, c) < 0 && (c = c.toLowerCase()), d[c] = qq.isFunction(b) ? b() : b
                            }), d
                        }
                    }
            ...
            _determineObjectPropertyValue: function(a, b) {
                var c = this._options.objectProperties[b],
                    d = new qq.Promise,
                    e = this;
                return qq.isFunction(c) ? (c = c(a), qq.isGenericPromise(c) ? d = c : d.success(c)) : qq.isString(c) && d.success(c), d.then(function(c) {
                    e["_" + b + "s"][a] = c
                }, function(c) {
                    qq.log("Problem determining " + b + " for ID " + a + " (" + c + ")", "error")
                }), d
            },
            _determineBucket: function(a) {
                return this._determineObjectPropertyValue(a, "bucket")
            },
            _determineHost: function(a) {
                return this._determineObjectPropertyValue(a, "host")
            },
    ...
    }(), window.Uint8ClampedArray || (window.Uint8ClampedArray = function() {}), qq.s3.RequestSigner = function(a) {
        "use strict";
        ...
        function c(a, b, c) {
            var d, e, f, g = new qq.Promise,
                ...
                p = function(a) {
                    var c, g = [];
                    return qq.each(a.headers, function(a) {
                        j.push(a)
                    }), j.sort(), qq.each(j, function(b, d) {
                        qq.indexOf(qq.s3.util.UNSIGNABLE_REST_HEADER_NAMES, d) < 0 ? l += d.toLowerCase() + ":" + a.headers[d].trim() + "\n" : "Content-MD5" === d ? c = a.headers[d] : g.unshift(b)
                    }), qq.each(g, function(a, b) {
                        j.splice(b, 1)
                    }), e = {
                        bucket: a.bucket,
                        contentMd5: c,
                        ...
                        date: o,
                        drift: k.signatureSpec.drift,
                        endOfUrl: d,
                        hashedContent: a.hashedContent,
                        headerNames: j,
                        headersStr: l,
                        method: h
                    }, f = 2 === b ? m.getStringToSign(e) : n.getStringToSign(e), {
                        date: o,
                        endOfUrl: d,
                        signedHeaders: 4 === b ? n.getSignedHeaders(e.headerNames) : null,
                        toSign: 4 === b ? f.hashed : f,
                        toSignRaw: 4 === b ? f.raw : f
                    }
                };
            switch (c.type) {
                case i.REQUEST_TYPE.MULTIPART_ABORT:
                    h = "DELETE", d = qq.format("uploadId={}", c.uploadId);
                    break;
                case i.REQUEST_TYPE.MULTIPART_INITIATE:
                    d = "uploads";
                    break;
                case i.REQUEST_TYPE.MULTIPART_COMPLETE:
                    d = qq.format("uploadId={}", c.uploadId);
                    break;
                case i.REQUEST_TYPE.MULTIPART_UPLOAD:
                    h = "PUT", d = qq.format("partNumber={}&uploadId={}", c.partNum, c.uploadId)
            }
            return d = c.key + "?" + d, 4 === b ? n.getEncodedHashedPayload(c.content).then(function(a) {
                c.headers["x-amz-content-sha256"] = a, c.headers.Host = c.host, c.headers["x-amz-date"] = qq.s3.util.getV4PolicyDate(o, k.signatureSpec.drift), c.hashedContent = a, g.success(p(c))
            }) : g.success(p(c)), g
        }

        function d(a, b, c, d, g) {
            var h;
            b.signatureConstructor ? (g && (h = b.signatureConstructor.getHeaders(), h[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = g, b.signatureConstructor.withHeaders(h)), b.signatureConstructor.getToSign(a).then(function(a) {
                f(b.signatureConstructor, a.stringToSign, c)
            })) : (g && qq.s3.util.refreshPolicyCredentials(b, g), e(b, c, d, g))
        }

        function e(a, b, c, d) {
            4 === k.signatureSpec.version ? n.signPolicy(a, b, c, d) : m.signPolicy(a, b, c, d)
        }

        function f(a, b, c) {
            4 === k.signatureSpec.version ? n.signApiRequest(a, b, c) : m.signApiRequest(a, b, c)
        }
        var g, h, i = this,
            j = {},
            k = {
            ...
            l = function(a, b, c) {
                var d = a.getHeaders();
                d.Authorization = 4 === k.signatureSpec.version ? qq.s3.util.V4_ALGORITHM_PARAM_VALUE + " Credential=" + k.signatureSpec.credentialsProvider.get().accessKey + "/" + qq.s3.util.getCredentialsDate(a.getRequestDate()) + "/" + k.signatureSpec.region + "/" + "s3/aws4_request," + "SignedHeaders=" + a.getSignedHeaders() + "," + "Signature=" + b : "AWS " + k.signatureSpec.credentialsProvider.get().accessKey + ":" + b, c.success(d, a.getEndOfUrl())
            },
            m = {
                getStringToSign: function(a) {
                    return qq.format("{}\n{}\n{}\n\n{}/{}/{}", a.method, a.contentMd5 || "", a.contentType || "", a.headersStr || "\n", a.bucket, a.endOfUrl)
                },
                signApiRequest: function(a, b, c) {
                    var d = CryptoJS.enc.Utf8.parse(b),
                        e = CryptoJS.HmacSHA1(d, h.get().secretKey),
                        f = CryptoJS.enc.Base64.stringify(e);
                    l(a, f, c)
                },
                signPolicy: function(a, b, c, d) {
            ...
            n = {
                getCanonicalQueryString: function(a) {
                    var b, c, d, e = a.indexOf("?"),
                        f = "";
                    return e >= 0 && (b = {}, d = a.substr(e + 1).split("&"), qq.each(d, function(a, c) {
                        var d = c.split("="),
                            e = d[1];
                        null == e && (e = ""), b[encodeURIComponent(d[0])] = encodeURIComponent(e)
                    }), c = Object.keys(b).sort(), c.forEach(function(a, d) {
                        f += a + "=" + b[a], d < c.length - 1 && (f += "&")
                    })), f
                },
                getCanonicalRequest: function(a) {
                    return qq.format("{}\n{}\n{}\n{}\n{}\n{}", a.method, n.getCanonicalUri(a.endOfUrl), n.getCanonicalQueryString(a.endOfUrl), a.headersStr || "\n", n.getSignedHeaders(a.headerNames), a.hashedContent)
                },
                getCanonicalUri: function(a) {
                    var b = a,
                        c = a.indexOf("?");
                    return c > 0 && (b = a.substr(0, c)), escape("/" + decodeURIComponent(b))
                },
                getEncodedHashedPayload: function(a) {
                    var b, c = new qq.Promise;
                    return qq.isBlob(a) ? (b = new FileReader, b.onloadend = function(a) {
                        if (a.target.readyState === FileReader.DONE)
                            if (a.target.error) c.failure(a.target.error);
                            else {
                                var b = CryptoJS.lib.WordArray.create(a.target.result);
                                c.success(CryptoJS.SHA256(b).toString())
                            }
                    }, b.readAsArrayBuffer(a)) : (a = a || "", c.success(CryptoJS.SHA256(a).toString())), c
                },
                getScope: function(a, b) {
                    return qq.s3.util.getCredentialsDate(a) + "/" + b + "/s3/aws4_request"
                },
                getStringToSign: function(a) {
                    var b = n.getCanonicalRequest(a),
                        c = qq.s3.util.getV4PolicyDate(a.date, a.drift),
                        d = CryptoJS.SHA256(b).toString(),
                        e = n.getScope(a.date, k.signatureSpec.region),
                        f = "AWS4-HMAC-SHA256\n{}\n{}\n{}";
                    return {
                        hashed: qq.format(f, c, e, d),
                        raw: qq.format(f, c, e, b)
                    }
                },
                getSignedHeaders: function(a) {
                    var b = "";
                    return a.forEach(function(c, d) {
                        b += c.toLowerCase(), d < a.length - 1 && (b += ";")
                    }), b
                },
                signApiRequest: function(a, b, c) {
                    var d, e, f, g, i = h.get().secretKey,
                        j = /.+\n.+\n(\d+)\/(.+)\/s3\/.+\n(.+)/,
                        k = j.exec(b);
                    d = CryptoJS.HmacSHA256(k[1], "AWS4" + i), e = CryptoJS.HmacSHA256(k[2], d), f = CryptoJS.HmacSHA256("s3", e), g = CryptoJS.HmacSHA256("aws4_request", f), l(a, CryptoJS.HmacSHA256(b, g), c)
                },
                signPolicy: function(a, b, c, d) {
                    var e, f, g, i, j, k = JSON.stringify(a),
                        l = CryptoJS.enc.Utf8.parse(k),
                        m = CryptoJS.enc.Base64.stringify(l),
                        n = h.get().secretKey,
                        o = /.+\/(.+)\/(.+)\/s3\/aws4_request/,
                        p = function() {
                            var b = null;
                            return qq.each(a.conditions, function(a, c) {
                                var d = c["x-amz-credential"];
                                return d ? (b = d, !1) : void 0
                            }), b
                        }();
                    e = o.exec(p), f = CryptoJS.HmacSHA256(e[1], "AWS4" + n), g = CryptoJS.HmacSHA256(e[2], f), i = CryptoJS.HmacSHA256("s3", g), j = CryptoJS.HmacSHA256("aws4_request", i), b.success({
                        policy: m,
                        signature: CryptoJS.HmacSHA256(m, j).toString()
                    }, c, d)
                }
            };
        qq.extend(k, a, !0), h = k.signatureSpec.credentialsProvider, g = qq.extend(this, new qq.AjaxRequester({
            ...
            getSignature: function(a, b) {
                var c, e = b,
                    f = b.signatureConstructor,
                    i = new qq.Promise;
                return 4 === k.signatureSpec.version && (c = {
                    v4: !0
                }), h.get().secretKey && window.CryptoJS ? h.get().expiration.getTime() > Date.now() ? d(a, b, i) : h.onExpired().then(function() {
                    d(a, b, i, h.get().accessKey, h.get().sessionToken)
                }, function() {
                    k.log("Attempt to update expired credentials apparently failed! Unable to sign request.  ", "error"), i.failure("Unable to sign request - expired credentials.")
                }) : (k.log("Submitting S3 signature request for " + a), f ? f.getToSign(a).then(function(b) {
                    e = {
                        headers: b.stringToSignRaw
                    }, g.initTransport(a).withParams(e).withQueryParams(c).send()
                }) : g.initTransport(a).withParams(e).withQueryParams(c).send(), j[a] = {
                    promise: i,
                    signatureConstructor: f
                }), i
            },
            constructStringToSign: function(a, b, d, e) {
                var f, g, i, j, l, m = {};
                return {
                    withHeaders: function(a) {
                        return m = a, this
                    ...
                    getToSign: function(n) {
                        var o = h.get().sessionToken,
                            p = new qq.Promise,
                            q = new Date(Date.now() + k.signatureSpec.drift);
                        return m["x-amz-date"] = q.toUTCString(), o && (m[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = o), c(n, k.signatureSpec.version, {
                            bucket: b,
                            content: g,
                            contentType: i,
                            headers: m,
                            ...
                            l = a, p.success({
                                headers: function() {
                                    return i && (m["Content-Type"] = i), delete m.Host, m
                                }(),
                                date: l.date,
                                endOfUrl: l.endOfUrl,
                                signedHeaders: l.signedHeaders,
                                stringToSign: l.toSign,
                                stringToSignRaw: l.toSignRaw
                            })
                        }), p
                    },
                    getHeaders: function() {
        ...
        function b(a) {
            var b, c = g.getBucket(a),
                d = g.getHost(a),
                f = {},
                h = new qq.Promise,
                i = g.getKey(a);
            return f["x-amz-acl"] = g.aclStore.get(a), g.reducedRedundancy && (f[qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), g.serverSideEncryption && (f[qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), f[qq.s3.util.AWS_PARAM_PREFIX + g.filenameParam] = encodeURIComponent(g.getName(a)), qq.each(g.paramsStore.get(a), function(a, b) {
                qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, a) >= 0 ? f[a] = b : f[qq.s3.util.AWS_PARAM_PREFIX + a] = encodeURIComponent(b)
            }), b = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_INITIATE, c, d, i).withContentType(g.getContentType(a)).withHeaders(f), e.getSignature(a, {
                signatureConstructor: b
            }).then(h.success, h.failure), h
        }
        ...
        function b(a, b, c) {
            var d = new qq.Promise,
                e = h.getBucket(a),
                g = h.getHost(a),
                i = f.constructStringToSign(f.REQUEST_TYPE.MULTIPART_COMPLETE, e, g, h.getKey(a)).withUploadId(b).withContent(c).withContentType("application/xml; charset=UTF-8");
            return f.getSignature(a, {
                signatureConstructor: i
            }).then(d.success, d.failure), d
        }
        ...
        qq.extend(h, a), f = new qq.s3.RequestSigner({
            ...
            send: function(a, c, f) {
                var i = new qq.Promise,
                    j = d(f);
                return b(a, c, j).then(function(b, c) {
        ...
        function b(a, b) {
            var c = new qq.Promise,
                d = f.getBucket(a),
                g = f.getHost(a),
                h = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_ABORT, d, g, f.getKey(a)).withUploadId(b);
            return e.getSignature(a, {
                signatureConstructor: h
            }).then(c.success, c.failure), c
        }
        ...
        var c = b.getName,
            ...
            o = a.objectProperties.region,
            p = a.objectProperties.serverSideEncryption,
            q = a.validation,
            r = qq.extend({
                region: o,
                drift: e
            ...
            s = this,
            t = a.signature.credentialsProvider,
            u = {
                combine: function(a) {
                    var b = s._getPersistableData(a).uploadId,
                        c = s._getPersistableData(a).etags,
                        d = new qq.Promise;
                    return v.completeMultipart.send(a, b, c).then(d.success, function(b, c) {
                        d.failure(x.done(a, c).response, c)
                    }), d
                },
                done: function(a, b, c) {
                    var d, e = x.response.parse(a, b);
                    e.success && (d = b.getResponseHeader("ETag"), s._getPersistableData(a).etags || (s._getPersistableData(a).etags = []), s._getPersistableData(a).etags.push({
                        part: c + 1,
                        etag: d
                    }))
                },
                initHeaders: function(a, b, c) {
                    var d = x.bucket.getName(a),
                        e = x.host.getName(a),
                        f = x.key.urlSafe(a),
                        g = new qq.Promise,
                        h = v.restSignature.constructStringToSign(v.restSignature.REQUEST_TYPE.MULTIPART_UPLOAD, d, e, f).withPartNum(b + 1).withContent(c).withUploadId(s._getPersistableData(a).uploadId);
                    return v.restSignature.getSignature(a + "." + b, {
                        signatureConstructor: h
                    }).then(g.success, g.failure), g
                },
                put: function(b, c) {
                    var d = s._createXhr(b, c),
                        e = s._getChunkData(b, c),
                        f = a.endpointStore.get(b),
                        g = new qq.Promise;
                    return u.initHeaders(b, c, e.blob).then(function(a, h) {
                        var i = f + "/" + h;
                        s._registerProgressHandler(b, c, e.size), x.track(b, d, c).then(g.success, g.failure), d.open("PUT", i, !0), qq.each(a, function(a, b) {
                            d.setRequestHeader(a, b)
                        }), d.send(e.blob)
                    }, function() {
                        g.failure({
                ...
                send: function(a, b) {
                    var c = new qq.Promise;
                    return u.setup(a).then(function() {
                        u.put(a, b).then(c.success, c.failure)
                    }, function(a, b) {
                        c.failure({
                            error: a
                        }, b)
                ...
                setup: function(a) {
                    var b = new qq.Promise,
                        c = s._getPersistableData(a).uploadId,
                        d = new qq.Promise;
                    return c ? c instanceof qq.Promise ? c.then(function(a) {
                        b.success(a)
                    }) : b.success(c) : (s._getPersistableData(a).uploadId = d, v.initiateMultipart.send(a).then(function(c) {
                        s._getPersistableData(a).uploadId = c, d.success(c), b.success(c)
                    }, function(c) {
                        s._getPersistableData(a).uploadId = null, b.failure(c), d.failure(c)
                    })), b
                }
            },
            v = {
                abortMultipart: new qq.s3.AbortMultipartAjaxRequester({
                    ...
                    log: d,
                    getBucket: function(a) {
                        return x.bucket.getName(a)
                    },
                    getHost: function(a) {
                        return x.host.getName(a)
                    },
                    getKey: function(a) {
                        return x.key.urlSafe(a)
                    }
                }),
            ...
            w = {
                initParams: function(a) {
                    var b = k.get(a);
                    return b[j] = c(a), qq.s3.util.generateAwsParams({
                        endpoint: l.get(a),
                        clockDrift: e,
                        params: b,
                        type: s._getMimeType(a),
                        bucket: x.bucket.getName(a),
                        key: s.getThirdPartyFileId(a),
                        accessKey: t.get().accessKey,
                        ...
                        region: o,
                        serverSideEncryption: p,
                        signatureVersion: r.version,
                        log: d
                    }, qq.bind(v.policySignature.getSignature, this, a))
                },
                send: function(a) {
                    var b = new qq.Promise,
                        c = s._createXhr(a),
                        e = s.getFile(a);
                    return s._registerProgressHandler(a), x.track(a, c).then(b.success, b.failure), w.setup(a, c, e).then(function(b) {
                ...
                setup: function(a, b, c) {
                    var d = new FormData,
                        ...
                        f = e,
                        g = new qq.Promise;
                    return w.initParams(a).then(function(a) {
            ...
            x = {
                bucket: {
                    promise: function(a) {
                        var b = new qq.Promise,
                            c = s._getFileState(a).bucket;
                        return c ? b.success(c) : g(a).then(function(c) {
                            s._getFileState(a).bucket = c, b.success(c)
                        }, b.failure), b
                    },
                    getName: function(a) {
                        return s._getFileState(a).bucket
                    }
                },
                host: {
                    promise: function(a) {
                        var b = new qq.Promise,
                            c = s._getFileState(a).host;
                        return c ? b.success(c) : h(a).then(function(c) {
                            s._getFileState(a).host = c, b.success(c)
                        }, b.failure), b
                    },
                    getName: function(a) {
                        return s._getFileState(a).host
                    }
                },
                done: function(a, b) {
                    var c = x.response.parse(a, b),
                        e = c.success !== !0;
                    return e && x.response.shouldReset(c.code) && (d("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), c.reset = !0), {
                        success: !e,
                        response: c
                    }
                },
                key: {
                    promise: function(a) {
                        var b = new qq.Promise,
                            d = s.getThirdPartyFileId(a);
                        return null == d ? (s._setThirdPartyFileId(a, b), i(a, c(a)).then(function(c) {
                            s._setThirdPartyFileId(a, c), b.success(c)
                        }, function(c) {
                            s._setThirdPartyFileId(a, null), b.failure(c)
                        })) : qq.isGenericPromise(d) ? d.then(b.success, b.failure) : b.success(d), b
                    },
                    urlSafe: function(a) {
                        var b = encodeURIComponent(s.getThirdPartyFileId(a));
                        return b.replace(/%2F/g, "/")
                    }
                },
                response: {
                    parse: function(a, b) {
                        var c, e = {};
                        try {
                            d(qq.format("Received response status {} with body: {}", b.status, b.responseText)), b.status === f ? e.success = !0 : (c = x.response.parseError(b.responseText), c && (e.error = c.message, e.code = c.code))
                        } catch (g) {
                ...
                start: function(a, b) {
                    var c = new qq.Promise;
                    return x.key.promise(a).then(function() {
                        x.bucket.promise(a).then(function() {
                            x.host.promise(a).then(function() {
                                null == b ? w.send(a).then(c.success, c.failure) : u.send(a, b).then(c.success, c.failure)
                            })
                        })
                    }, function(a) {
                        c.failure({
                ...
                track: function(a, b, c) {
                    ...
                    return b.onreadystatechange = function() {
                        if (4 === b.readyState) {
                            var e;
                            null == c ? (e = x.done(a, b), d[e.success ? "success" : "failure"](e.response, b)) : (u.done(a, b, c), e = x.done(a, b), d[e.success ? "success" : "failure"](e.response, b))
                        }
                    }, d
                }
            };
        qq.extend(this, {
            ...
            return {
                expunge: function(b) {
                    var c = s._getPersistableData(b) && s._getPersistableData(b).uploadId,
                        d = s._maybeDeletePersistedChunkData(b);
                    void 0 !== c && d && v.abortMultipart.send(b, c), a.expunge(b)
                },
        ...
        function c(b, c) {
            var d, e, f, g = a.endpointStore.get(b),
            ...
            try {
                ...
                m("Error when attempting to parse form upload response (" + j.message + ")", "error")
            }
            return !1
        }
        ...
        function d(a) {
            var b = q.get(a);
            return b[p] = k(a), qq.s3.util.generateAwsParams({
                endpoint: r.get(a),
                clockDrift: i,
                params: b,
        ...
        function f(a) {
            ...
            return e(a, b).then(function(e) {
                e.appendChild(d), h._attachLoadEvent(b, function(d) {
                    m("iframe loaded"), d ? d.success === !1 && (m("Amazon likely rejected the upload request", "error"), f.failure(d)) : (d = {}, d.success = c(a, b), d.success === !1 ? (m("A success response was received by Amazon, but it was invalid in some way.", "error"), f.failure(d)) : (qq.extend(d, qq.s3.util.parseIframeResponse(b)), f.success(d))), g(a, b)
        ...
        var h = this,
            ...
            r = a.endpointStore,
            s = a.aclStore,
            t = a.objectProperties.reducedRedundancy,
            u = a.objectProperties.region,
        ...
        qq.extend(this, new qq.FormUploadHandler({
            ...
            uploadFile: function(a) {
                var b = k(a),
                    c = new qq.Promise;
                return h.getThirdPartyFileId(a) ? h._getFileState(a).bucket ? f(a).then(c.success, c.failure) : n(a).then(function(b) {
                    h._getFileState(a).bucket = b, f(a).then(c.success, c.failure)
                }) : o(a, b).then(function(b) {
                    n(a).then(function(d) {
    ...
    function() {
        ...
        return {
            ...
            _paramNameMatchesAzureParameter: function(a) {
                switch (a) {
                    case "Cache-Control":
            ...
            _getPrefixedParamName: function(a) {
                return qq.azure.util._paramNameMatchesAzureParameter(a) ? a : qq.azure.util.AZURE_PARAM_PREFIX + a
            },
            getParamsAsHeaders: function(a) {
                var b = {};
                return qq.each(a, function(a, c) {
                    var d = qq.azure.util._getPrefixedParamName(a),
                        e = null;
                    qq.isFunction(c) ? e = String(c()) : qq.isObject(c) ? qq.extend(b, qq.azure.util.getParamsAsHeaders(c)) : e = String(c), null !== e && (b[d] = qq.azure.util._paramNameMatchesAzureParameter(a) ? e : encodeURIComponent(e))
                }), b
            },
    ...
    function() {
        ...
        qq.azure.FineUploaderBasic = function(a) {
            ...
            qq.extend(b, a, !0), qq.FineUploaderBasic.call(this, b), this._uploadSuccessParamsStore = this._createStore(this._options.uploadSuccess.params), this._uploadSuccessEndpointStore = this._createStore(this._options.uploadSuccess.endpoint), this._failedSuccessRequestCallbacks = {}, this._cannedBlobNames = {}
            ...
            _determineBlobName: function(a) {
                ...
                switch (b) {
                    case "uuid":
                        return void 0 !== e && (f += "." + e), (new qq.Promise).success(f);
                    case "filename":
...
function(a) {
    ...
    var i = [],
        j = f.SHA256 = e.extend({
            ...
            _doProcessBlock: function(a, b) {
                for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], j = c[4], k = c[5], l = c[6], m = c[7], n = 0; 64 > n; n++) {
                    if (16 > n) i[n] = 0 | a[b + n];
                    else {
                        var o = i[n - 15],
                    ...
                    var s = j & k ^ ~j & l,
                        ...
                        w = m + v + s + h[n] + i[n],
                        x = u + t;
                    m = l, l = k, k = j, j = 0 | g + w, g = f, f = e, e = d, d = 0 | w + x
                }
        ...
        var a = CryptoJS,
            ...
            e = c.init = function(a) {
                if (a instanceof ArrayBuffer && (a = new Uint8Array(a)), (a instanceof Int8Array || a instanceof Uint8ClampedArray || a instanceof Int16Array || a instanceof Uint16Array || a instanceof Int32Array || a instanceof Uint32Array || a instanceof Float32Array || a instanceof Float64Array) && (a = new Uint8Array(a.buffer, a.byteOffset, a.byteLength)), a instanceof Uint8Array) {
                    for (var b = a.byteLength, c = [], e = 0; b > e; e++) c[e >>> 2] |= a[e] << 24 - 8 * (e % 4);
                    d.call(this, c, b)
