          ...
          <link rel="stylesheet" href="/resources/demos/style.css">
            <script>
             ...
             <section class="moduleTitle">
                <fieldset>
                    <form action="index.php?module=Leads&action=exam_ragistration&search_leads=1" method="post" id="exam_from">
                       <h1 align="center">Exam Manager</h1> 
					   <h2>Search Student</h2><br/><br/>
								...
								<tr style="background-color:#fff;">
									<td><table width="92%" border="0" cellpadding="0" cellspacing="0">
										 <tr>
															...
															<tr>
																<tr>
																  <td><b>Please Enter Enrollment ID</b></td>
																  <td><input type="text" name="enroll_id" id="enroll_id"/></td>	
																   <td><input type="Submit" name="Search" value="Submit Enroll ID"></td>
																</tr>
														</table>
													</table>
												</fieldset>
