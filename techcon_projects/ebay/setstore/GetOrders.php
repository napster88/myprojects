...
$requestXmlBody .= '<SiteId>0</SiteId>';
$requestXmlBody .= ' <DetailLevel>ReturnAll</DetailLevel>';
$requestXmlBody .= ' <LevelLimit>1</LevelLimit>';
$requestXmlBody .= ' <Store>';
$requestXmlBody .= ' <Name>Magical Books</Name>';
$requestXmlBody .= ' <SubscriptionLevel>Basic</SubscriptionLevel>';
$requestXmlBody .= ' <Description>Books that take you places.</Description>';
$requestXmlBody .= ' </Store>';
