...
$DelRel="Delete from te_exam_scheme_te_pr_programs_c Where te_exam_scheme_te_pr_programste_exam_scheme_ida='".$bean->id."'";
			$GLOBALS['db']->query($DelRel);	
		...
		$DelRel="Delete from te_exam_types_te_exam_scheme_c Where te_exam_types_te_exam_schemete_exam_scheme_ida='".$bean->id."'";
		$GLOBALS['db']->query($DelRel);	
