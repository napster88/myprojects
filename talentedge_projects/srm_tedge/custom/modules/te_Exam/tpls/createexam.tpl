...
<form name="search_form" id="search_form" class="search_form" method="post" action="index.php?module=te_Exam&action=createexam&form=002">
	<div>
				 ...
				 <table width="100%" cellspacing="0" cellpadding="0" border="0">
					<tr> 
						<td nowrap="nowrap" width="10%">	
							...
							<textarea id="description" name="description" style="width: 1266px; height: 128px;" class="required" required></textarea> 
						</td>
					</tr>
					<tr>
						<td  nowrap="nowrap" width="10%">
