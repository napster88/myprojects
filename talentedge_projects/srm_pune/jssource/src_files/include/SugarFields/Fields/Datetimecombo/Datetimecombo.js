...
Datetimecombo.prototype.html = function(callback) {
	...
	var text = '<span style="position:relative; top:-1px;"><select class="datetimecombo_time" size="1" id="' + this.fieldname + '_hours" tabindex="' + this.tabindex + '" onchange="combo_' + this.fieldname + '.update(); ' + callback + '">';
