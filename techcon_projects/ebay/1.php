<head>
  ...
  <body>
    ...
    <script> function _cb_findItemsByKeywords(root) { var items = root && root.findItemsByKeywordsResponse && root.findItemsByKeywordsResponse[0] && root.findItemsByKeywordsResponse[0].searchResult && root.findItemsByKeywordsResponse[0].searchResult[0] && root.findItemsByKeywordsResponse[0].searchResult[0].item || []; var html = []; html.push('
	  ...
	  <script src="https://svcs.ebay.com/services/search/FindingService/v1?SECURITY-APPNAME=kapiltha-EBAYTEST-PRD-108faa0a3-8783ecde&OPERATION-NAME=findItemsByKeywords&SERVICE-VERSION=1.0.0&RESPONSE-DATA-FORMAT=JSON&callback=_cb_findItemsByKeywords&REST-PAYLOAD&keywords=iphone&paginationInput.entriesPerPage=6&GLOBAL-ID=EBAY-IN&siteid=203"></script> 
    </body>
  </html>
