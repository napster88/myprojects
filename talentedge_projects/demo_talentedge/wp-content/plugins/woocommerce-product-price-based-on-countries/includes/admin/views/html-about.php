...
<div class="wrap about-wrap">
	...
	<?php if ( isset( $_GET['tab'] ) && $_GET['tab'] ==='credits' ) : ?>
		...
		<p class="about-description"><?php printf( __( 'If you have any questions or just want to say hi, %scontact me!%s</p>', 'wc-price-based-country' ), '<a href="http://www.pricebasedcountry.com/contact/">', '</a>'); ?></p>
	...
	<div class="feature-section two-col">
		<h2><?php _e( 'Multi-currency Improvements' ); ?></h2>
		<div class="col">
			...
			<p><?php printf( __( 'The older versions don\'t support sales reports for multi-currency, showing a wrong result. Version 1.6 shows sales reports in your base currency and calculates amounts of orders made in a different currency by exchange rate.' ), WCPBC()->version ) ; ?></p>
		</div>
		<div class="col">
			<h3><?php _e( 'Coupons' ); ?></h3>
			...
			<p><?php _e( 'You can choose if the coupon amount should be calculated using exchange rate. Great for multi-currency stores!' ); ?></p>
		</div>
	</div>
