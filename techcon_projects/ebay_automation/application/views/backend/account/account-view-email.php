            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="container">
                            <input id="authorize-button" type="button" class="btn btn-primary "value="Add New" onclick="this.disabled = true"/>
                            <input type="text" class="email">
                            <a href="https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://techconlabs.net/ebay_automation/account/view_user_account_email" class="btn btn-primary pull-right" style="margin-right: 186px;">remove session</a>
                          ...
                          var clientId = '276924124683-hh53hqen2bsvtkc3n3vshfjbbuoif0pj.apps.googleusercontent.com';
                             var apiKey = 'AIzaSyA9gqghsKapxjdfd5e7WAVen3zFwi3W5oI';
                                ...
                                function displayInbox() {
                                 ...
                                 <iframe height="600" width="800" id="message-iframe-'+message.id+'" srcdoc="<p>Loading...</p>">\
                                 </iframe>\
                                 </div>\
                                 </div>\
                                 </div>\
