...
<div class="thumb-post"><!--   thumb-post -->
<a href="<?php echo site_url('magazin/article-'.$data_item['id'])?>">
<img src="<?php echo base_url()?>download/article/<?php echo $data_item['photo'];?>">
</a>
<div class="tit-3dd"><a href="<?php echo site_url('magazin/article-'.$data_item['id'])?>"> <?php echo lang("Magazin")?> </a> </div>
</div><!--  end thumb-post -->
