...
class Ad3 extends CI_Controller {
   ...
   public function index()
   {
     ...
     $data['data']        = $this->data->get("ads",FALSE,array("atype"=>2),FALSE,TRUE) ;
     ...
     $this->load->view('administrator/pages/ads_table3',$data);
   ...
   public function add()
   {
      ...
      $data['cats']        = $this->data->get("cats",FALSE,array("parent"=>0),FALSE,TRUE) ;
       ...
       $this->load->view('administrator/global/topbar');
       $this->load->view('administrator/global/menu');
       $this->load->view('administrator/pages/ads_form3',$data);
       $this->load->view('administrator/global/footer');
   }
   ...
   public function delete($slug)
	{
    	...
    	redirect('administrator/ad3', 'refresh');
