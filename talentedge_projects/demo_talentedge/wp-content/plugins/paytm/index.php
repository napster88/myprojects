...
$redirect_url = $order->get_checkout_order_received_url();
        ...
        public function generate_paytm_form($order_id){
			...
			// JAI // error_log("redirect url = this {$redirect_url}");
			//////////////
            $order_id = $order_id;
            ...
            "ORDER_ID" => $order_id,
            "CUST_ID" => str_replace(' ','',$order -> billing_first_name),
            "TXN_AMOUNT" => $amt,
	...
	//	echo "123456789";exit;	
		...
		//	echo "test test test test";
           ...
           /* foreach($paytm_args as $key => $value){
			...
			$paytm_args_array[] = "<input type='hidden' name='CUST_ID' value='". str_replace(' ','',$order -> billing_first_name) ."'/>";
