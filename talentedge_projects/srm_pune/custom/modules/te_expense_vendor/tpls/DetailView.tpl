			...
			function(inputValue){
			  ...
			  if (inputValue === "") {
				...
				return false
				 ...
				 $.post( "index.php?module=te_expense_vendor&action=approval&to_pdf=1", { type: "reject", record: records ,reason:inputValue })
				  .done(function( data ) {
			...
			function(inputValue){
			  ...
			  if (inputValue === "") {
				...
				return false
				 ...
				 $.post( "index.php?module=te_expense_vendor&action=approval&to_pdf=1", { type: "cancel", record: records ,reason:inputValue })
				  .done(function( data ) {
