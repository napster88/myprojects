...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php"><img src="themes/default/images/logo.png"></a>
        ...
        <div class="hidden-xs hidden-sm" id="bs-example-navbar-collapse-1">
            ...
            <div id="globalLinks" class="dropdown nav navbar-nav navbar-right">
                <li id="usermenu" class="dropdown-toggle" aria-expanded="true">
                    <a style="border-bottom:0px;"href='index.php?module=Users&action=EditView&record={$CURRENT_USER_ID}'><span class="glyphicon glyphicon-user"> </span> {$CURRENT_USER}
    ...
    <div id='sidebar_container' class="container-fluid">
        ...
        <div class="row">
            <div {if $smarty.cookies.sidebartoggle == 'collapsed'}style="display:none"{/if} class="col-sm-3 col-md-2 sidebar">
                ...
                <div id="recentlyViewedSidebar" style="display:none;" ><span id = "statusCount"><h2>Status Wise Count</h2>{$statusWiseCount}</span><div style="clear: both;">&nbsp;</div>
                    <h2 class="recent_h3">{$APP.LBL_LAST_VIEWED}</h2></br>
                    <ul class="nav nav-pills nav-stacked">
                        {foreach from=$recentRecords item=item name=lastViewed}
