...
if (isset($_POST["Import"]))
{
    ...
    if ($_FILES["file"]["size"] > 0)
    {
        ...
        echo '<br><br><h2>CRM institute</h2>';
        $file     = fopen($filename, "r");
        fgetcsv($file);
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
        {
            ...
            echo "update te_in_institutes set web_institute_id=$institue_web_id where id='$institue_crm_id';<br>";
        ...
        echo '<br><br><h2>CRM Programme & Batch</h2>';
        $file     = fopen($filename, "r");
        fgetcsv($file);
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
        {
            ...
            echo "update te_pr_programs set web_id=$web_program_id where id='$crm_programme_id';<br>";
            echo "update te_ba_batch set web_batch_id=$web_batch_id where id='$crm_id_programme';<br>";
