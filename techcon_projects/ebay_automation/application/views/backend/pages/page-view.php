<div class="content-wrapper" style="min-height: 916px;">
	...
	<input type="hidden" class="delete_url" value="<?php echo base_url('pages/hide'); ?>" />
    <!-- Main content -->
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php if(!empty($pagelist)){
					...
					<tr id="row_<?php echo $data->id; ?>">
					  ...
					  <td>
						<a class="btn btn-app" href="<?php echo base_url('pages/page/'.$data->slug); ?>"><i class="fa fa-eye"></i> View</a>
						<a class="btn btn-app" href="<?php echo base_url('pages/edit_page/'.$data->id); ?>"><i class="fa fa-edit"></i> Edit</a>
