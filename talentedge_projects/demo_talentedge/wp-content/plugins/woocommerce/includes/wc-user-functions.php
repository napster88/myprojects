...
if ( ! function_exists( 'wc_create_new_customer' ) ) {
	...
	function wc_create_new_customer( $email, $username = '', $password = '' ) {
		...
		if ( empty( $email ) || ! is_email( $email ) ) {
			...
			//return '<p>An account is already registered with your email address. Please <a href="'.home_url().'/#loginpopup">Login</a></p>';
		}

		if ( email_exists( $email ) ) {
			return new WP_Error( 'registration-error-email-exists', __( 'An account is already registered with your email address. Please <a href="#checkout_popup">Login</a>.', 'woocommerce' ) );
			//return '<p>An account is already registered with your email address. Please <a href="'.home_url().'/#loginpopup">Login</a></p>';
		}
