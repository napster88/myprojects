...
$user = fetch('GET', '/v1/people/~:(firstName,lastName,emailAddress,id,picture-urls::(original),location,industry,specialties,positions,summary,skills)');
// echo "<pre>";
// print_r($user); 
	...
	<head>
		<script>
			function assignData(){
                ...
                window.opener.wpl_ProfilePic='<?php echo $pictureUrl;?>';
                window.opener.wpl_Position='<?php echo $designation;?>';
                window.opener.wpl_Firstname='<?php echo $user->firstName;?>';
                window.opener.wpl_Lastname='<?php echo $user->lastName;?>';
                window.opener.wpl_Industry='<?php echo $industry;?>';
                window.opener.wpl_Location='<?php echo $state;?>';
                window.opener.wpl_Companyname='<?php echo $companyName;?>';
                window.opener.wpl_socialNetwork='linkedin';
                window.opener.wpl_linkedinCheck='yes';
