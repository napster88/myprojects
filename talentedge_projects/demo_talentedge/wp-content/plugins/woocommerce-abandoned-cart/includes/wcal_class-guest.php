...
if ( ! class_exists( 'woocommerce_guest_ac' ) ) {
    ...
    function user_side_js() {
        ...
        <script type="text/javascript">
            jQuery( 'input#billing_phone' ).on( 'change', function() {
                var data = {
        ...
        if ( ! is_user_logged_in() ) {            
            ...
            if ( isset( $_SESSION['billing_last_name'] ) ) {
             ...
             if ( isset($_SESSION['billing_phone'] ) ) {
                $billing_guest_phone = $_SESSION['billing_phone'];
            } else {
                $billing_guest_phone = '';
            }
            ...
            $insert_guest = "INSERT INTO `".$wpdb->prefix . "ac_guest_abandoned_cart_history_lite`( billing_first_name, billing_last_name, email_id, billing_zipcode, shipping_zipcode, shipping_charges, phone ) 
                            VALUES ( '".$billing_first_name."', '".$billing_last_name."', '".$_SESSION['billing_email']."', '".$billing_zipcode."', '".$shipping_zipcode."', '".$shipping_charges."', '".$billing_guest_phone."' )";
