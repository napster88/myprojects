...
<div id="content" class="span10">
            ...
            <div class="control-group">
				...
				<div class="controls">
				  <select id="selectError4" name="status" data-placeholder="<?php echo lang("Status"); ?>" data-rel="chosen">
                     <?php
					...
					<option value="1" <?php echo $A1; ?> ><?php echo lang("Pending"); ?></option>
					<option value="2" <?php echo $I1; ?> ><?php echo lang("Shipped"); ?></option>
					<option value="3" <?php echo $I2 ?> ><?php echo lang("Delivered"); ?></option>
				  </select>
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                 <a style="margin-top: 22px;" class="btn btn-info btn-small"  href="javascript:document.getElementById('search').submit();">
          ...
          <ul>
             <li>
                <a data-rel="tooltip"  class="well3 span3 top-block" href="">
					...
					<div><?php echo lang("totalsell"); ?></div>
					<div><?php
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						&nbsp;
						<div class="box-icon">
							<a class="btn btn-success btn-small" href="<?php echo site_url("administrator/orders/printD")?>?<?php echo $_SERVER['QUERY_STRING']?>"  style="width:110px;" target="_blank">
