...
<div id="content" class="span10">
          ...
          <ul>
			...
			<label class="control-label" for="typeahead"><?php echo lang("city") ;?></label>
							  <div class="controls">
                                                              <select name="city" class="span6 typeahead">
							  ...
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="Cform[password]" id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]'>
