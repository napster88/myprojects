<!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
	...
	<li class="<?php if($active == 'Account'){echo 'active';} ?> treeview">
		...
		<li <?php if($active_sub == 'view_email'){echo 'class="active"';} ?>><a href="<?php  echo base_url('account/view_user_account_email');?>"><i class="fa fa-circle-o"></i>Gmails Account</a></li>
	...
	<li class="<?php if($active == 'ups'){echo 'active';} ?> treeview">
		...
		<li class="<?php if($active == 'Subscription'){echo 'active';} ?> treeview">
          ...
          <ul class="treeview-menu">
            <li <?php if($active_sub == 'view_subscription'){echo 'class="active"';} ?>><a href="<?php echo base_url('');?>"><i class="fa fa-circle-o"></i> Sold List</a></li>
