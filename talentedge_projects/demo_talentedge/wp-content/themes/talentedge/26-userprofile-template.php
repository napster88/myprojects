   ...
   <main id="main" class="site-main" role="main">
      ...
      <div class="clearfix userProfile_wrapper">
                  ...
                  <div class="pad-lt-30 pad-rt-30">
                     ...
                     <div class="verticalMiddle">
                        ...
                        <?php
                           ...
                           $regularPrice = get_product_price($prod_id, $order_currency);
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 installment_dataSHow">
                                       <div class="installment_section">
                                          ...
                                          <?php
                                             ...
                                             get_installment_data($prod_id, $order_currency);
                                             ?>	
                                          <?php } ?>
                                       </div>
                                    </div>
                                    ...
                                    <div class="product_actual_price">
                                       ...
                                       <div class="total_amount">
                                          <h6 class="text-bold">
                                             ...
                                             <span class="product_price">
                                             <?php
                                                echo $currencySymbol . $afterdiscount;
                                                ?>
                                             </span>
                                          </h6>
                                       </div>
                                       ...
                                       <div class="paid">
                                          <h6  class="text-bold">
                                             ...
                                             <span class="paid_amount">
                                                <?php
                                                   echo $currencySymbol . $amount_extax;
                                                   ?>
                                                <!-- <i class="fa">i</i> -->
                                             </span>
                                          </h6>
         ...
         <div class='nologin'>
            ...
            <?php echo do_shortcode('[userpro template=login login_redirect= ' . $currentUrl . ' option=value login_heading="Log in"]'); ?>
         </div>
         ;
         <?php }
            ?>
