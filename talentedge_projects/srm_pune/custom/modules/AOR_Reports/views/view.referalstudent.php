    ...
    $leadsData=array();
	  $user_id=$current_user->id;
		...
		if(isset($_POST['export']) && $_POST['export']=="Export"){
			$data="Student,Batch,Email,Phone,Referral Person,Create By\n";
			...
			foreach($councelorList as $key=>$councelor){
				...
				$data.= "\"" . $councelor['student'] . "\",\"" . $councelor['batch'] . "\",\"". $councelor['email']. "\",\"". $councelor['mobile']. "\",\"". $ref_person. "\",\"". $councelor['createdby']. "\"\n";
			}
			ob_end_clean();
