...
@font-face {
  ...
  src: url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-v=4.7.0.eot");
  src: url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-.eot#iefix&v=4.7.0") format("embedded-opentype"), url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-v=4.7.0.woff2") format("woff2"), url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-v=4.7.0.woff") format("woff"), url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-v=4.7.0.ttf") format("truetype"), url("//talentedge.in/wp-content/themes/talentedge/icons/fontawesome-webfont-v=4.7.0.svg#fontawesomeregular") format("svg");
  font-weight: normal;
  font-style: normal; }
.fa {
  display: inline-block;
...
@font-face {
  ...
  src: url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.eot");
  src: url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.eot#iefix") format("embedded-opentype"), url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.woff2") format("woff2"), url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.ttf") format("truetype"), url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.woff") format("woff"), url("//talentedge.in/wp-content/themes/talentedge/icons/Simple-Line-Icons-v=2.4.0.svg#simple-line-icons") format("svg");
  font-weight: normal;
  font-style: normal; }
...

{
    ...
    ul.ui-icon-blocks.who-we-are-block li.ui-icon-block span{position: static; margin-right:13px; display: flex; justify-content: center; min-width: 42px;}
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category orange">
										<div>
											...
											<span>Benefit from working with top Indian and international academic brands
</span>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<div>
											...
											<span>Earning potential of  1-4 lakhs per month upon becoming a partner</span>
							...
							<div class="row no-gape">
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<div>
											<i class="la la-bullhorn"></i>
											<span>Dedicated support in planning, budgeting and marketing strategies
</span>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category blue">
										<div>
											<i class="la la-graduation-cap"></i>
											<span>100% Revenue & Student growth in 2 years
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<div>
											<i class="la la-line-chart "></i>
											<span>Over 28 channel partners from across 15 major cities
   					...
   					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" data-vertical_center="true">
   						...
   						<ul class="ui-icon-blocks ui-blocks-v icons-lg who-we-are-block">
   							...
   							<li class="ui-icon-block animate" data-show="fade-in">
   								...
   								<h5 class="text-dark-gray">Impacted careers of 92% of students who completed the course </h5>
   							</li>
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" data-vertical_center="true">
            ...
            <ul class="ui-icon-blocks ui-blocks-v icons-lg who-we-are-block">
              <li class="ui-icon-block animate points" data-show="fade-in">
                ...
                <h5 class="text-dark-gray">Courses from top institutes of the country, in high demand
</h5>
              </li>
              <li class="ui-icon-block animate" data-show="fade-in">
                <span class="fa fa-handshake-o text-purple"></span>
                <h5 class="text-dark-gray">Dedicated support in planning, budgeting, marketing strategies, training and induction of staff
              ...
              <li class="ui-icon-block animate" data-show="fade-in">
                ...
                <h5 class="text-dark-gray">Management of entire student life cycle after sourcing of admission by Channel Partner.
...
<!-- <div class="section fouth bg-elig">
              ...
              Why you should do this:
                ...
                <div class="row">
                    ...
                    <p class="paragraph">
                      Alliance with industry leader in ed-tech space, partnering with world’s leading institutes
                    ...
                    <p class="paragraph">
                      Market relevant and industry specific, live & interactive classes
                    ...
                    <p class="paragraph">
                      Opportunity to earn Rs. 1-4 lakhs per month, 12-48 lakhs per annum
                    </p>
                    </div>
                    </div>
                    </div>
  ...
  <div class="container">
    <h2 class="heading text-indigo T-cent">How to connect with Us</h2>
        <div class="col-sm-12 col-xs-12 ui-icon-block text-cnter media3">
          <p>
            Call or send an email to <span>Amit Mishra</span> on Mobile: <span>9711637957</span> and Email id: <span>partner.support2@talentedge.in</span> or fill the form and we will get back to you.
