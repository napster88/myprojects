...
<h1><?php echo lang("ContactUs2")?></h1>
</div>
...
<div class="tit-5br-m"><a href="<?php echo site_url('contact/contact-'.$data_item['id'])?>">  <?php echo $data_item['title'];?> </a></div>
<div class="m7t-5br-m">
<p>
 <?php echo $data_item['desc'];?>
</p>
<a href="<?php echo site_url('contact/contact-'.$data_item['id'])?>"><?php echo lang("ReadMore")?></a>
</div>
