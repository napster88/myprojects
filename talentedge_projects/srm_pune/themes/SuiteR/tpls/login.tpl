...
<!-- <div class="container loginBg">
    <div id="loginform">
        <div class="col-xs-12 col-sm-6 col-sm-offset-3">
            ...
            <div class="logiFormWrap">
                <form class="form-signin formLoginStud" role="form" action="index.php" method="post" name="DetailView" id="form" onsubmit="return document.getElementById('cant_login').value == ''">
                ...
                <form class="form-signin passform formforStud" role="form" action="index.php" method="post" name="DetailView" id="form" name="fp_form" id="fp_form" >
        ...
        <!-- <div class="col-xs-12 col-sm-6">
            <div class="logintalentImg">
                <img src="../../../../themes/default/images/logintalent.png" width="814" height="736" alt="Talent Login">
            </div>
        </div> 
    </div>   
</div> -->
...
<div class="loginWrap">
    <div class="container-fluid">
        <div class="row1">
            <div class="col-md-9 col-sm-8 col-xs-12 p-l-0 mobileWelcome">
                <div class="l-detail">
                    <!-- <h5>Welcome</h5> -->
                    {$LOGIN_IMAGE}
                    <h3>Live &amp; Interactive digital learning</h3>
                </div>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12 p-r-0">
    ...
    <div id="instance1"><canvas width="1322" height="600"></canvas></div>
</div>

<!-- Animation Js --> 
<script src="custom/include/login/jparticles.js.download"></script>
<script src="custom/include/login/particle.js.download"></script>
<script src="custom/include/login/event.js.download"></script>
