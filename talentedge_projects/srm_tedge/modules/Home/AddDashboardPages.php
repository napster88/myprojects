...
if(!isset($_POST['dashName'])){
    ...
    $html .='<tr>';
    $html .='<td><label for="dashName">'.$GLOBALS['app_strings']['LBL_ENTER_DASHBOARD_NAME'].'</label>';
    $html .='<input type="text" name="dashName" id="dashName" class="form-control"></td>';
    $html .='</tr>';
    $html .='<tr>';
    $html .='<td><label for="numColumns">'.$GLOBALS['app_strings']['LBL_NUMBER_OF_COLUMNS'].' </label>';
    $html .='<select name="numColumns" class="form-control">';
