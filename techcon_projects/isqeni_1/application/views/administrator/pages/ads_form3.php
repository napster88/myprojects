			...
			<div>
				<ul class="breadcrumb">
					<li>
                     ...
                     <li>
					   <a href="<?php echo site_url("administrator/ad3/")?>">  إعلانات الدخله</a> <span class="divider">/</span>
					</li>
					<li>
						<?php echo lang("Add") ;?>
					</li>
						...
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" style="min-height: 600px; overflow: hidden;">
                         ...
                         <div class="control-group" id="titlegroup">
							...
							<div class="form-actions">
                              ...
                              <input type="hidden" name="Cform[atype]" value="2"/>
