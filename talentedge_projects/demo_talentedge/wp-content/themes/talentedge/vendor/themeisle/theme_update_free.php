...
function talentedge_theme_updater() {


    $theme_data =   wp_get_theme(basename(get_template_directory() ));
    $edd_updater = new talentedge_Theme_Updater( array(
...
//add_action( 'admin_init', 'talentedge_theme_updater' );

if(!class_exists('talentedge_Theme_Updater')) {
    class talentedge_Theme_Updater {
