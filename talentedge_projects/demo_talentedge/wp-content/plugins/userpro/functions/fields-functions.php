		...
		$res .= "<div class='userpro-input'>";
			...
			switch($array['type']) {
				...
				case 'antispam':
					...
					$rand1 = rand(1, 10);
					$rand2 = rand(1, 10);
					$res .= "<span class= 'ans_antispam'>".sprintf(__('Answer: %s + %s','userpro'), $rand1, $rand2)."</span>";
					$res .= "<input type='text' data-required='1' placeholder='Captcha*' name='$key-$i' id='$key-$i' value='' $data />";
