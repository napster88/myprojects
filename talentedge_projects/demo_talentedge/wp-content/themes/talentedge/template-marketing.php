...
<body <?php body_class();?>>
 ...
 <input type="hidden" class="utm_institute" value="<?php echo  $inshort_name; ?>">
                ...
                <div class="container">
                    <div class="valign">
                        <ul id="list_scroll" class="nav">
                            <?=($post->ID==33767)? '' : '<li><a href="#view_programe_Highlights">HIGHLIGHTS</a></li>';?>
                            <?=($post->ID==33767)? '' : '<li><a href="#view_programe_Detail">DETAILS</a></li>';?>
                            ...
                            <?php
                                ...
                                if( have_rows('content_section') ):
                                    ...
                                    if(get_sub_field('headline')=='Upcoming Events' && $post->ID==33767)  continue;
                                    if(get_sub_field('headline')=='Content Gallery' && $post->ID==33767)  continue;
                                    if(get_sub_field('headline')=='About Talentedge+' && $post->ID==33767)  continue;
                                    ?>
                                ...
                                $instrcutorshead = get_field('faculty');
                                ?>
                            <li <?php if( !$instrcutorshead ){ echo "style='display:none'"; }?>><a href="#view_Faculty">  <?=($post->ID==33767)? 'Speakers' : 'FACULTY';?></a></li>
                            <?=($post->ID==33767)? '<li><a href="#view_3">About Talentedge+</a></li>' : '';?>
                ...
                <div class="right-te col-md-4 col-sm-4 xs-hidden">
                    <div class="coverCard">
                        <div class="batch-Card">
                            <div class="guidForm">
                            <p class="form_head"><?=($post->ID==33767)? 'Register to attend the live talk series' : 'Book Free 1 on 1 session with our counsellors';?></p>
                               <?php
                                    echo do_shortcode('[gravityform id=7 title=false description=false ajax=true tabindex=50]');
                                ?>
																<div class="guidForm-bottom">
																		<ul>
                                      <?php if(get_field('form_box_1', get_the_ID(), true) != ''){ ?>
                                        <li class="first"><i><img src="https://demo1.talentedge.in/wp-content/uploads/2018/06/building.png"/></i><?php echo get_field('form_box_1', get_the_ID(), true); ?></li>
                                    <?php  }?>
                                    <?php if(get_field('form_box_2', get_the_ID(), true) != ''){ ?>
                                      <li class="second"><i><img src="https://demo1.talentedge.in/wp-content/uploads/2018/06/right.png"/></i><?php echo get_field('form_box_2', get_the_ID(), true); ?></li>
                                  <?php  }?>
																			</ul>
																</div>
													 ...
													 <?php endif; ?>
													 <?=($post->ID==33767)? '<div class="text-center last_duration"><span class="makeBold">Limited Seats available</span></div>' : '';?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="clearfix twoColumn-layout">
            ...
            if( have_rows('content_section') ):
                        ...
                        <div class="col-md-8 col-sm-12  col-xs-12 institute_left">
                            ...
                            <h2 class="head-title"><?php echo get_sub_field('headline');?></h2>
                                <div class="post-content list-arrow-white black-arrow">
                                    ...
                                    if(get_sub_field('headline')=='About Talentedge+' && $post->ID==33767){?>
                                    <br>
                                    <div class="text-center">
                   <button type="button"onClick="window.open('https://talentedge.in/browse-courses/');"  class="btn btn-info" formtarget="_blank">Explore Our Courses</button>
                                    </div>
                    ...
                    <?php
                     if($post->ID==33767 && get_sub_field('headline')=='Live Talks'){ ?>

                        <div id="view_Faculty" class="view_Faculty ">
                <div class="container">
                    <div class="">
                        <div class="clearfix"><h2><?=($post->ID==33767)? 'Speakers' : 'Faculty';?></h2></div>
                    </div>
                    <div class="clearfix">
             ...
             if($post->ID!=33767){
                 $instrcutors = get_field('faculty');
            ?>
            <div id="view_Faculty" class="view_Faculty " <?php if( !$instrcutors ){ echo "style='display:none'"; }?> >
                <div class="container">
                    <div class="">
                        <div class="clearfix"><h2><?=($post->ID==33767)? 'Speakers' : 'Faculty';?></h2></div>
                    </div>
    ...
    <div class="container">
        <h2><?=($post->ID==33767)? 'Register to attend the live talk series' : 'Get In Touch';?></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 toggle">
                        <div class="inner">
                            <h5>Usage</h5>
                            <ul class="li">
                                <li><a href="<?php echo home_url();?>/terms-of-use">Terms of Use</a></li>Faculty
...
padding: 0 78px !important;
 ...
 <?php } ?>
<?php $brochureLink  =  get_field('brouchure',$courseId);?>
...
$(document).ready(function() {
    ...
    if($post->ID==33767){ ?>
    $("#input_7_14").hide();
    $("#gform_submit_button_7").val("Book My Seat");
   ...
   // $('#input_7_16').val('<?php echo get_the_title();?>');
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
        ...
        $('footer .toggle h5').on('click', function(e) { /*utm tracking*/
            e.preventDefault();
  ...
  /*utm tracking*/ //23,22,7,5
        ...
        if(utm_term == null){
          ...
          $('#input_1_17').val('<?php echo $courseId ;?>');
          ...
          $('#input_5_17').val('<?php echo $courseId ;?>');
	  $('#input_7_21').val("<?php echo $brochureLink; ?>");
