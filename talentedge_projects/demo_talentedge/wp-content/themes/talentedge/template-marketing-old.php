...
?>
<input type="hidden" class="utm_coursedata" value="<?php echo  $batch_name; ?>">
<input type="hidden" class="utm_course_shortname" value="<?php echo  $courseshort_name; ?>">
                        ...
                        <div class="batch-Card">
                            <div class="guidForm">
                               <?php
                                ...
                                ?>
                                <div class="text-center last_duration"><span>Last date of application: 31st July 16</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                summary.scrollToFixed({
                    ...
                    limit: function() {
                        ...
                        if (next) {
                            ...
                            limit = $('.subscibe-section').offset().top - 
