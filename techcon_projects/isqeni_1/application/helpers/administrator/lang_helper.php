...
if ( ! function_exists('Text2Uni'))
{
    function Text2Uni($word = '')
    {
		$new_word = array();
	$char_type = array();
    ...
    if(! in_array($word[0].$word[1],$all_chars))
    {
      $new_word[] = $all_chars[$word[0].$word[1]];
	  $char_type[] = 'normal';
      //var_dump($word[0].$word[1]);die;
    };
...
if ( ! function_exists('getRead'))
{
    function getRead($var = '')
    {
		if($var == 1)
		{
			$result = '<span class="label label-success">&nbsp;&nbsp;'.lang("DoneRead").'&nbsp;&nbsp;</span>';
		}
		else if($var == 0)
		{
			$result = '<span class="label label-important">&nbsp;&nbsp;'.lang("NonRead").'&nbsp;&nbsp;</span>';
		}
        else
		{
			$result = "";
...
if ( ! function_exists('getRead2'))
{
    function getRead2($var = '')
    {
		if($var == 1)
		{
			$result = '<span class="label label-success">&nbsp;&nbsp;'."تم الحجز".'&nbsp;&nbsp;</span>';
		}
		else if($var == 0)
		{
			$result = '<span class="label label-important">&nbsp;&nbsp;'."لم يتم الحجز".'&nbsp;&nbsp;</span>';
		}
        else
		{
			$result = "";
