                          ...
                          foreach($data AS $data_item){
                           ...
                           ?>
							<tr>
                                ...
                                <td class="center"><?php $dd = $this->data->get("branchs",FALSE,array("id"=>$data_item['branch_id'])) ; echo isset($dd['name'])?$dd['name'] : "لا يوجد" ;?></td>
								<td class="center">
								   	<a class="btn btn-info" href="<?php echo site_url("administrator/area/add/".$data_item['id']."");?>">
										<i class="icon-edit icon-white"></i>
										<?php echo lang("Edit") ;?>
									</a>
									<a onClick="return confirm('<?php echo lang("WantDelete") ;?>')" class="btn btn-danger" href="<?php echo site_url("administrator/area/delete/".$data_item['id']."");?>">
										<i class="icon-trash icon-white"></i>
