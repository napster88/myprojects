 ...
 *
 * Template Name: business analytics big data nlp
 *
 */
 ?>
 <html lang="en">
<head>
	...
	<style>
.popup-form-container .gform_footer { padding-left:35px; }
.cd-popup-container .ginput_container
{
padding:10px;
}
...
.p-category.red > a span {
	color:#fff !important;}
	.p-category.orange > a span {
	color:#fff !important;}
.p-category.blue > a span {
	color:#fff !important;}
...
.gravity_form_footer input[type=text]
{
	...
	/*---kuldeep*/
		...
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields
		{
			width:100%;
			margin: 0;
			padding: 0;
		...
		.gform_wrapper form#gform_30 .gform_body ul.gform_fields{
			width:100%;
			margin: 0;
			padding: 0 5px 10px 0;
		}
		.gravity_form_footer > .gform_wrapper form#gform_30 .gform_body ul.gform_fields li{
			width: 25%;
			float: left;
			display: inline-block;
		}
  ...
  $last_date=$date_array[0]."/".$monthName."/".$date_array[2];
    ...
    <nav class="navbar navbar-fixed-top transparent navbar-default">
		<div class="container">
			...
			<!-- Navbar Logo -->
			<a class="ui-variable-logo navbar-brand iimk" href="index.html" title="Talentedge">
            ...
            <a class=" right-logo" href="index.html" title="Talentedge">
				<!-- Default Logo -->
    ...
    <div class="main" role="main">
    	...
    	<!-- Hero Slider -->
		<div class="ui-hero ui-hero-slider slider-pro hero-lg"
			data-fade="true"
			data-touch_swipe="false"
			data-auto_play="true"
			data-autoplay_delay="5500"
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12" data-vertical_center="true" data-vertical_offset="16">
								<h1 class="heading sp-layer" data-show-transition="left" data-show-delay="300" data-show-duration="500">
									Executive Certificate Program In Business Analytics and Big Data
								</h1>
							<p class="paragraph sp-layer" data-show-transition="left" data-show-delay="400" data-show-duration="500">
									<img src="<?php echo site_url();?>/wp-content/uploads/2018/03/title1.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive desk" >
                                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/03/mob-title.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive mob" >
								</p>
				...
				<div class="sp-slide">
					<div class="container">
						<div class="row">
							<div class="col-sm-12" data-vertical_center="true" data-vertical_offset="16">
								<h1 class="heading sp-layer" data-show-transition="left" data-show-delay="300" data-show-duration="500">
									Prepare for Careers of Future in Data Science & Analytics
								</h1>
								<p class="paragraph sp-layer" data-show-transition="left" data-show-delay="400" data-show-duration="500">
									<img src="<?php echo site_url();?>/wp-content/uploads/2018/03/title2.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive desk" >
                                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/03/mob-title2.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive mob" >
								</p>
				...
				<div class="sp-slide">
					<div class="container">
						<div class="row">
							<div class="col-sm-12" data-vertical_center="true" data-vertical_offset="16">
								<h1 class="heading sp-layer" data-show-transition="left" data-show-delay="300" data-show-duration="500">
									 Application Oriented Course with Hands-On Learning
								</h1>
								<p class="paragraph sp-layer" data-show-transition="left" data-show-delay="400" data-show-duration="500">
									<img src="<?php echo site_url();?>/wp-content/uploads/2018/03/title3.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive desk" >
                                    <img src="<?php echo site_url();?>/wp-content/uploads/2018/03/mob-title3.png" alt="Live & Interactive Online Program from IIM Kashipur" class="img-responsive mob" >
								</p>
   ...
   <div class="section ui-gradient-peach form ui-action-section" id="form11">
   			<div class="container-fluid">
   				<div class="">
                    ...
                    <h3><?php echo $last_date; ?></h3>

                    </div>
                    <div class="col-md-10 col-sm-12 text-block">

										<div class="form-group">
											<div class="form1 gravity_form_footer">

                                             <!--   <div class="col-sm-3">
												<input autocomplete="name" class="input form-control" data-validation="required" name="name" placeholder="Your Name *">
                                                </div>
                                                <div class="col-sm-3">
												<input autocomplete="Phone" class="input form-control" data-validation="required" name="phone" placeholder="Your Phone *">
                                                </div>
                                                <div class="col-sm-3">
												<input autocomplete="Email" class="input form-control" data-validation="required" name="email" placeholder="Your Email *">
                                                </div>
                                                  <div class="col-sm-3 con-btn">
                                                  <button type="submit" class="btn btn-block shadow-md">Submit</button>
                                                  </div>  -->

 <?php	echo do_shortcode('[gravityform id=30 title=false description=false ajax=false tabindex=30]');?>
  ...
  <ul class="actions">
    <li><a href="#" id="contact" class="button big"><img src="<?php echo site_url();?>/wp-content/uploads/2018/03/enrol-btn.png" alt="btn"></a></li>
  </ul>
</div>
<div class="cd-popup contact" role="alert">
  <div name="contactform" id="contactform" class="contact-form">
    <div class="cd-popup-container" style="height: 340px;">
     ...
     <div class="popup-form-container">
										...
										<div class="form-group">
											<div class="form1 ">
<span class="tt_cont_form"> <?php echo do_shortcode('[gravityform id=30 title=false description=false ajax=false tabindex=30]'); ?></span>
<span class="tt_download_form"> <?php echo do_shortcode('[gravityform id=9 title=false description=false ajax=false tabindex=30]'); ?></span>
                                          ...
                                          <!--      <div class="col-sm-12 martop10">
												...
												<input autocomplete="Email" class="input form-control" data-validation="required" name="email" placeholder="Your Email *">
                                                  ...
                                                  <div class="col-sm-12 martop12 con-btn">
                                                  <button type="submit" class="btn btn-block shadow-md">Submit</button>
                                                  </div>
												  34	  -->
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category orange">
										<a href="#" title="">
											...
											<span>Model business problems as decision analytics problems</span>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<a href="#" title="">
											...
											<span>Apply supervised and unsupervised techniques</span>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category red">
										<a href="#" title="">
											...
											<span>Apply social network analysis</span>
							...
							<div class="row no-gape">
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<a href="#" title="">
											<i class="la la-bullhorn"></i>
											<span>Work with tools like Gephi</span>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category blue">
										<a href="#" title="">
											<i class="la la-graduation-cap"></i>
											<span>Understand Spark, Python, Hadoop, Hive and Impala</span>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="p-category white">
										<a href="#" title="">
											<i class="la la-line-chart "></i>
											<span>Set-up a big data stack in single node machine and Amazon AWS</span>
   					...
   					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" data-vertical_center="true">
   						...
   						<ul class="ui-icon-blocks ui-blocks-v icons-lg">
   							<li class="ui-icon-block animate points" data-show="fade-in">
   								<span class="icon icon-diamond text-purple"></span>
   								<h5 class="text-dark-gray">Certification from IIM Kashipur</h5>
   							</li>
   							<li class="ui-icon-block animate" data-show="fade-in">
   								<span class="icon icon-pie-chart text-purple"></span>
   								<h5 class="text-dark-gray">Taught by eminent IIM faculty<br>& Industry Experts</h5>

   							</li>
   							<li class="ui-icon-block animate" data-show="fade-in">
   								<span class="icon icon-layers text-purple"></span>
   								<h5 class="text-dark-gray">Live & Interactive Online Classes<br>- NOT Recorded Videos</h5>

   							</li>
   							<li class="ui-icon-block animate" data-show="fade-in">
   								<span class="icon icon-chemistry text-purple"></span>
   								<h5 class="text-dark-gray">Take the Next Step to a<br>Rewarding Analytics Career</h5>

   							</li>
   						</ul>
   					</div>
   				</div>
                <div class="section-heading center mb-0 martop40">

   					<a href="#">


   					<h2 class="heading brochure">
   						Download Brochure
   					</h2>
                    </a>
   					<p class="paragraph">
   						Download the course brochure for detailed syllabus
   					</p>
   				</div>
   			</div>
   		</div>
 ...
 <div class="section fouth bg-elig">
                ...
                <div class="row">
                    ...
                    <p class="paragraph">
   					...
   					<br><br>
   						...
   						Live & Interactive Online -  <?php echo $duration;?>
   					</p>
                    </div>
                    </div>
                      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="boxpack1">
                      <h2>Fees</h2>
                    <p class="paragraph">
   						Indian Students – INR  <?php echo $fee_inr;?> + GST
                        <br>International Students – USD <?php echo $fee_USD;?>
                        <br><br>(Instalment Available)
   					</p>
                    </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="boxpack1">
                      <h2>Eligibility</h2>
                    <p class="paragraph">
   						Graduation with formal education in mathematics or statistics
                        <br><br>Minimum 2 years of work experience as on May 2018 preferably in IT, Data Analysis or Market Research
   					</p>
                    </div>
                    </div>
                    </div>
   		...
   		<div class="section">
   			<div class="container">
   				...
   				<div class="col-sm-4 col-xs-12 ui-icon-block text-center media3">
   						<div class="icon icon-lg text-lime"><img src="<?php echo site_url();?>/wp-content/uploads/2018/03/fac.png" alt="alumuni" class="img-circle"></div>
   						<h4>Arunabh Sinha</h4>
                        <h5>Business Operations Associate Manager, Accenture
<br>May 2017 Batch</h5>

   					</div>
                    <div class="col-sm-8 col-xs-12 ui-icon-block text-center media3">


   						<p>
							Good curriculum covering all the relevant topics. Knowledge of faculty is commendable and LMS was also a good experience.<br>Now I know the areas where I should explore further. I highly recommend this program.
						</p>
   					</div>
   			</div><!-- .container -->
   		</div><!-- .section -->
   		<!-- Pricing Cards Section -->
   		<!--<div class="section bg-light third">
   			<div class="container">
   				...
   				<div class="row ui-blog-grid eligibiliy">

					<div class="col-md-4">
						<div class="ui-card post-item ui-action-card shadow-sm bg-lime" >

							<div class="card-image" data-bg="assets/img/man1.png" data-uhd></div>

							<div class="card-header eligibiliy">
								<h4 class="heading">For Indian Participants</h4>

							</div>

							<div class="card-body">
								<p>Graduates from a recognized university (UGC/AICTE/DEC/AIU/State Government) in any discipline but with formal education in mathematics or statistics.</p>
							</div>
					...
					<div class="col-md-4">
						<div class="ui-card post-item ui-action-card shadow-sm" >

							<div class="card-image" data-bg="assets/img/international.png" data-uhd></div>

							<div class="card-header">
								<h4 class="heading text-white">For International Participants</h4>

							</div>

							<div class="card-body ">
								<p class="text-white">Graduation or equivalent degree with formal education in mathematics or statistics, from any recognized University or Institution in their respective country.</p>
							</div>
					...
					<div class="col-md-4">
						<div class="ui-card post-item ui-action-card shadow-sm bg-red" data-target="blog-post.html">

							<div class="card-image" data-bg="assets/img/exper.png" data-uhd></div>

							<div class="card-header">
								<h4 class="heading">Work Experience</h4>

							</div>

							<div class="card-body ">
								<p> <strong>Minimum 2 years of work experience</strong> as on 01 May 2018, preferably in IT, Data Analysis and/or Market Research</p>
							</div>
