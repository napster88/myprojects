...
class Ups_tracking extends CI_Controller {
	...
	public function view_ups_software()
	{
		
		$data['head_title'] = 'View UPS No.';
		$data['active'] = 'ups';
		$data['active_sub'] = 'view_ups';
		...
		$data['total_ups'] = $this->ups_model->viewups($userdata1->id);
		
		$this->load->view('template/head',$data);
		$this->load->view('template/header',$data);
		$this->load->view('template/sidenav',$data);
		$this->load->view('backend/ups/ups-view',$data);
		$this->load->view('template/footer',$data);
		$this->load->view('template/foot',$data);
	}
	
	
	public function view_order_fulfill($mode)
	{
		$data['head_title'] = 'View UPS No.';
		$data['active'] = 'ups';
		$data['active_sub'] = 'view_ups';
		...
		$data['userdata'] = $this->session->userdata('loggedin');
		$userdata1 = $this->session->userdata('loggedin');
		$data['total_ups'] = $this->ups_model->viewupsorder($userdata1->id,$mode);
		
		$this->load->view('template/head',$data);
		$this->load->view('template/header',$data);
		$this->load->view('template/sidenav',$data);
		$this->load->view('backend/ups/ups-order-view',$data);
		$this->load->view('template/footer',$data);
		$this->load->view('template/foot',$data);
	}
	public function add_transaction()
	{
		...
		$data['transactionlist'] = $this->ups_model->viewups();
		//$id = $userdata->id;
		$this->load->view('template/head',$data);
		$this->load->view('template/header',$data);
		$this->load->view('template/sidenav',$data);
